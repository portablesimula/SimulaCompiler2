...
javadoc -Xmaxwarns 1000 --release 24 --enable-preview -private -d C:\GitHub\SimulaCompiler2\Simula\doc -sourcepath C:\GitHub\SimulaCompiler2\Simula\src -subpackages simula
pause
