...
public class SAVED_AttrOutput {
     ...
     */
    public SAVED_AttrOutput(ObjectOutputStream out) {
        this.out = out;
    }
     ...
     * @throws     IOException  if some other I/O error occurs.
     */
    static int writeString(String str, SAVED_AttrOutput out) throws IOException {
        ...
        final byte[] bytearr;
        if (out instanceof SAVED_AttrOutput dos) {
