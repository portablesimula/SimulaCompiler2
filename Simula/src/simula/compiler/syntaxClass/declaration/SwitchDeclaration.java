...
//		this.declarationKind = ObjectKind.Switch;
//	}
//
//	@Override
//	public void writeObject(AttributeOutputStream oupt) throws IOException {
//		Util.TRACE_OUTPUT("BEGIN Write SwitchDeclaration: "+identifier);
//		oupt.writeKind(declarationKind); // Mark: This is a SwitchDeclaration
...
//
//		oupt.writeShort(switchList.size());
//		for(Expression expr:switchList) oupt.writeObj(expr);
//
//		Util.TRACE_OUTPUT("END Write SwitchDeclaration: "+identifier);
//	}
//
//	public static SwitchDeclaration readObject(AttributeInputStream inpt) throws IOException {
//		String identifier = inpt.readString();
//		Util.TRACE_OUTPUT("BEGIN Read SwitchDeclaration: "+identifier);
//		SwitchDeclaration pro = new SwitchDeclaration();
//		pro.identifier = identifier;
...
//
//		n = inpt.readShort();
//		System.out.println("SwitchDeclaration.readObject: n="+n);
//		for(int i=0;i<n;i++) {
//			Expression expr = (Expression) inpt.readObj();
//			System.out.println("SwitchDeclaration.readObject: expr="+expr);
//			pro.switchList.add(expr);
//		}
//		Util.TRACE_INPUT("END Read SwitchDeclaration: "+identifier+", Declared in: "+pro.declaredIn);
//		
////		Util.IERR();
//
