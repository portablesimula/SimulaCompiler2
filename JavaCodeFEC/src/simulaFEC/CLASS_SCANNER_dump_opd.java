...
public final class CLASS_SCANNER_dump_opd extends RTS_PROCEDURE {
    ...
    @Override
    public CLASS_SCANNER_dump_opd setPar(Object param) {
        try {
            switch(_nParLeft--) {
    ...
    public CLASS_SCANNER_dump_opd(RTS_RTObject _SL) {
        super(_SL,3); // Expecting 3 parameters
    }
    // Normal Constructor
    public CLASS_SCANNER_dump_opd(RTS_RTObject _SL,char sp_opdhi,char sp_opdlo,char sp_optx) {
        super(_SL);
    ...
    @Override
    public CLASS_SCANNER_dump_opd _STM() {
        ...
        if(_VALUE((p_optx!=(((char)0))))) {
            {
                ...
                RTS_BASICIO.sysout().outtext(((CLASS_SCANNER)(_CUR._SL)).DB.getELEMENT(RTS_ENVIRONMENT.rank(p_optx)));
                ;
                ...
                if(_VALUE((p_optx==(((char)2))))) {
                    ...
                    {
                        t=new CLASS_COMMON_nameof((_CUR._SL),p_opdhi,p_opdlo)._RESULT;
                        ;
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("CLASS_SCANNER.sim","5 dump_opd",1,58,13,59,49,60,52,61,57,62,60,63,64,64,70,65,76,66,80,67,84,68,97,70,99,71,110,72);
} // End of Procedure
