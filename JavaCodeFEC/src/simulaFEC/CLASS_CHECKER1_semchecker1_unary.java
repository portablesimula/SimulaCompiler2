...
public class CLASS_CHECKER1_semchecker1_unary extends CLASS_CHECKER1_semchecker1_arithop {
    // ClassDeclaration: Kind=9, BlockLevel=3, PrefixLevel=3, firstLine=516, lastLine=529, hasLocalClasses=false, System=false, detachUsed=false
    ...
    public RTS_PRCQNT emit_0() { return(new RTS_PRCQNT(this,CLASS_CHECKER1_semchecker1_unary_emit.class)); }
    // Normal Constructor
    public CLASS_CHECKER1_semchecker1_unary(RTS_RTObject staticLink,CLASS_CHECKER1_semchecker1_exp sp_pred,char sp_ch,CLASS_CHECKER1_semchecker1_exp sp1_left,CLASS_CHECKER1_semchecker1_exp sp1_right) {
    ...
    // Class Statements
    @Override
    public CLASS_CHECKER1_semchecker1_unary _STM() {
        CLASS_CHECKER1_semchecker1_unary _THIS=(CLASS_CHECKER1_semchecker1_unary)_CUR;
        _LOOP:while(_JTX>=0) {
            try {
                ...
                // BEGIN unary INNER PART
                // ENDOF unary INNER PART
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("CLASS_CHECKER1.sim","9 unary",1,516,10,461,27,169,29,223,31,443,35,444,41,445,44,446,50,448,53,449,56,450,69,452,72,453,75,454,80,456,85,457,87,459,96,461,108,465,114,466,116,467,126,469,128,470,131,471,140,474,142,529,157,529);
} // End of Class
