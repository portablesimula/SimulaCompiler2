...
public class CLASS_PARSER_grammer_blockOrComp extends CLASS_PARSER_grammer_statement {
    // ClassDeclaration: Kind=9, BlockLevel=3, PrefixLevel=1, firstLine=974, lastLine=1126, hasLocalClasses=false, System=false, detachUsed=true
