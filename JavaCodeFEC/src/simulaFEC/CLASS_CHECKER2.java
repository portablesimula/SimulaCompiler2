...
public class CLASS_CHECKER2 extends CLASS_CHECKER1 {
    ...
    // Normal Constructor
    public CLASS_CHECKER2(RTS_RTObject staticLink) {
        super(staticLink);
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("CLASS_CHECKER2.sim","8 CLASS_CHECKER2",1,3,19,1323,21,998,23,2395,25,89,27,2698,29,262,32,265,34,802,36,1887,38,2636,40,1664,54,1664);
} // End of Class
