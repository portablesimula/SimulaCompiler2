                                                ...
                                                // JavaLine 109 <== SourceLine 433
                                                {
                                                    ...
                                                    if(_VALUE(((((CLASS_COMMON_quantity)(_inspect_428_4529.curmeaning_1)).encl_1.blev!=(qblev))||((_inspect_428_4529.curmeaning_1==(qz)))))) {
                                                        // JavaLine 113 <== SourceLine 443
                                                        {
                                                            ...
                                                            {
                                                                _SIM_LABEL(2); // DeclaredIn: makevisblock -> makevisblock[externalIdent=CLASS_BUILDER1_precheck0_makevisblock] Kind=5, QUAL=ProcedureDeclaration, HashCode=1600888965
                                                                {
                                                                    // BEGIN INSPECTION 
