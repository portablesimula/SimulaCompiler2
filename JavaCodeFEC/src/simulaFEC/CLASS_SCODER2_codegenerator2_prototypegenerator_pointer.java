...
public final class CLASS_SCODER2_codegenerator2_prototypegenerator_pointer extends RTS_PROCEDURE {
...
public Object _RESULT() { return(_RESULT); }
    ...
    @Override
    public CLASS_SCODER2_codegenerator2_prototypegenerator_pointer setPar(Object param) {
        try {
            switch(_nParLeft--) {
    ...
    public CLASS_SCODER2_codegenerator2_prototypegenerator_pointer(RTS_RTObject _SL) {
        super(_SL,1); // Expecting 1 parameters
    }
    // Normal Constructor
    public CLASS_SCODER2_codegenerator2_prototypegenerator_pointer(RTS_RTObject _SL,CLASS_COMMON_quantity sp_qty) {
        super(_SL);
    ...
    @Override
    public CLASS_SCODER2_codegenerator2_prototypegenerator_pointer _STM() {
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("CLASS_SCODER2.sim","5 pointer",1,272,42,275,46,276,48,277,52,278,56,280,62,282,71,290);
} // End of Procedure
