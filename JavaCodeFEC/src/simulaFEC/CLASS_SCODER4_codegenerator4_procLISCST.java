...
public final class CLASS_SCODER4_codegenerator4_procLISCST extends RTS_PROCEDURE {
    ...
    final RTS_LABEL _LABEL_CLASS_SCODER4_codegenerator4_procLISCST_Block258_Block321_outLitPar_0=new RTS_LABEL(this,0,1,"outLitPar"); // Local Label #1=outLitPar At PrefixLevel 0
    // JavaLine 12 <== SourceLine 380
    final RTS_LABEL _LABEL_CLASS_SCODER4_codegenerator4_procLISCST_Block258_EXIT_0=new RTS_LABEL(this,0,2,"EXIT"); // Local Label #2=EXIT At PrefixLevel 0
    // Declare locals as attributes
    // JavaLine 15 <== SourceLine 255
    public int jjj=0;
    // JavaLine 17 <== SourceLine 257
    public CLASS_CHECKER2_semchecker _inspect_257_4659=null;
    // Normal Constructor
    public CLASS_SCODER4_codegenerator4_procLISCST(RTS_RTObject _SL) {
        super(_SL);
    ...
    @Override
    public CLASS_SCODER4_codegenerator4_procLISCST _STM() {
        CLASS_SCODER4_codegenerator4_procLISCST _THIS=(CLASS_SCODER4_codegenerator4_procLISCST)_CUR;
        _LOOP:while(_JTX>=0) {
            try {
                _JUMPTABLE(_JTX,2); // For ByteCode Engineering
                {
                    // BEGIN INSPECTION 
                    _inspect_257_4659=((CLASS_SCODER4_codegenerator4)(_CUR._SL)).checker_5;
                    if(_inspect_257_4659!=null) { // INSPECT _inspect_257_4659  type=ref(SEMCHECKER)
                        // JavaLine 38 <== SourceLine 258
                        {
                            // JavaLine 40 <== SourceLine 257
                            {
                                // JavaLine 42 <== SourceLine 258
                                if(_VALUE(RTS_UTIL._IS(((CLASS_SCODER4_codegenerator4)(_CUR._SL)).curpar_6,CLASS_COMMON_extquantity.class))) {
                                    {
                                        // JavaLine 45 <== SourceLine 259
                                        if(_VALUE((((CLASS_COMMON_extquantity)(((CLASS_SCODER4_codegenerator4)(_CUR._SL)).curpar_6)).clf_2==(((char)2))))) {
                                            {
                                                // JavaLine 48 <== SourceLine 260
                                                if(_VALUE(((((CLASS_SCODER4)(_CUR._SL._SL)).opt==(((char)8)))||((((CLASS_SCODER4)(_CUR._SL._SL)).opt==(((char)7))))))) {
                                                    {
                                                        ...
                                                        ;
                                                        _GOTO(_LABEL_CLASS_SCODER4_codegenerator4_procLISCST_Block258_EXIT_0); // GOTO EVALUATED LABEL
                                                        ;
                                                    }
                                                }
                                            }
                                ...
                                switch(((CLASS_SCODER4)(_CUR._SL._SL)).opt) { // BEGIN SWITCH STATEMENT
                                    ...
                                    // JavaLine 103 <== SourceLine 311
                                    {
                                        ...
                                        _GOTO(_LABEL_CLASS_SCODER4_codegenerator4_procLISCST_Block258_Block321_outLitPar_0); // GOTO EVALUATED LABEL
                                        ;
                                    }
                                    break;
                                    case 4: 
                                    // JavaLine 114 <== SourceLine 320
                                    {
                                        ...
                                        ((CLASS_SCODER4_codegenerator4)(_CUR._SL)).outbyte(RTS_TXT.length(((CLASS_SCODER4_codegenerator4)(_CUR._SL)).literal_6));
                                        ;
                                        ((CLASS_SCODER4_codegenerator4)(_CUR._SL)).outtext(((CLASS_SCODER4_codegenerator4)(_CUR._SL)).literal_6);
                                        ;
                                ...
                                if(_VALUE((((CLASS_SCODER4_codegenerator4)(_CUR._SL)).curpar_6==(null)))) {
                                    {
                                        // JavaLine 163 <== SourceLine 353
                                        ((CLASS_SCODER4_codegenerator4)(_CUR._SL)).outtext(CONC(new RTS_TXT("S"),new RTS_TXT("\u0088")));
                                        ;
                                        // JavaLine 166 <== SourceLine 354
                                        new CLASS_SCODER0_codegenerator0_outtag((_CUR._SL),((CLASS_SCODER4_codegenerator4)(_CUR._SL)).fpt_profile.getELEMENT(RTS_ENVIRONMENT.rank(((CLASS_SCODER4)(_CUR._SL._SL)).opt)));
                                        ;
                                        // JavaLine 169 <== SourceLine 355
                                        ((CLASS_SCODER4_codegenerator4)(_CUR._SL)).outtext(CONC(new RTS_TXT("Q"),new RTS_TXT("\r")));
                                        ;
                                        // JavaLine 172 <== SourceLine 356
                                        new CLASS_SCODER0_codegenerator0_outsint((_CUR._SL),(((CLASS_SCODER4_codegenerator4)(_CUR._SL)).curparno_6-(1)));
                                        ;
                                        // JavaLine 175 <== SourceLine 357
                                        ((CLASS_SCODER4_codegenerator4)(_CUR._SL)).outtext(CONC(CONC(new RTS_TXT("D"),new RTS_TXT("Q")),new RTS_TXT("\u0012")));
                                        ;
                                        ...
                                        new CLASS_SCODER0_codegenerator0_outtag((_CUR._SL),((CLASS_SCODER4_codegenerator4)(_CUR._SL)).litpardesvarianttag.getELEMENT(RTS_ENVIRONMENT.rank(((CLASS_SCODER4)(_CUR._SL._SL)).opt)));
                                        ;
                                        // JavaLine 193 <== SourceLine 366
                                        ((CLASS_SCODER4_codegenerator4)(_CUR._SL)).outtext(((((((CLASS_SCODER4)(_CUR._SL._SL)).opilo_6==('@'))&&((((CLASS_SCODER4)(_CUR._SL._SL)).opihi_6==(((char)0))))))?(CONC(CONC(CONC(CONC(new RTS_TXT("D"),new RTS_TXT("Q")),new RTS_TXT("\u0019")),new RTS_TXT("D")),new RTS_TXT("F"))):(CONC(new RTS_TXT("D"),new RTS_TXT("F")))));
                                        ;
                                        // JavaLine 196 <== SourceLine 371
                                        new CLASS_SCODER0_codegenerator0_outtag((_CUR._SL),((CLASS_SCODER4_codegenerator4)(_CUR._SL)).fpt_body.getELEMENT(RTS_ENVIRONMENT.rank(((CLASS_SCODER4)(_CUR._SL._SL)).opt)));
                                        ;
                                    }
                                } else {
                                    // JavaLine 201 <== SourceLine 373
                                    {
                                        ...
                                        new CLASS_SCODER0_codegenerator0_STRC2((_CUR._SL),new RTS_TXT("SCODER4"),377,new RTS_TXT("ASSIGN"));
                                        ;
                                        // JavaLine 215 <== SourceLine 378
                                        ((CLASS_SCODER4_codegenerator4)(_CUR._SL)).outbyte(111);
                                        ;
