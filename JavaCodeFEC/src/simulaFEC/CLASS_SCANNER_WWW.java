...
public final class CLASS_SCANNER_WWW extends RTS_PROCEDURE {
    ...
    @Override
    public CLASS_SCANNER_WWW setPar(Object param) {
        try {
            switch(_nParLeft--) {
    ...
    public CLASS_SCANNER_WWW(RTS_RTObject _SL) {
        super(_SL,1); // Expecting 1 parameters
    }
    // Normal Constructor
    public CLASS_SCANNER_WWW(RTS_RTObject _SL,RTS_TXT sp_t) {
        super(_SL);
    ...
    @Override
    public CLASS_SCANNER_WWW _STM() {
        // JavaLine 41 <== SourceLine 86
        {
            // BEGIN INSPECTION 
            _inspect_86_4463=RTS_BASICIO.sysout();
            if(_inspect_86_4463!=null) { // INSPECT _inspect_86_4463  type=ref(PRINTFILE)
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("CLASS_SCANNER.sim","5 WWW",1,86,11,87,41,86,46,87,62,87);
} // End of Procedure
