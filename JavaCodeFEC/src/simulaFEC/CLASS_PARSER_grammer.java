...
public class CLASS_PARSER_grammer extends CLASS_COMMON_component {
    // ClassDeclaration: Kind=9, BlockLevel=2, PrefixLevel=1, firstLine=125, lastLine=2696, hasLocalClasses=true, System=false, detachUsed=true
