...
public final class CLASS_SCANNER_recognizer_directive_bytefield extends RTS_PROCEDURE {
...
public Object _RESULT() { return(_RESULT); }
    ...
    // Normal Constructor
    public CLASS_SCANNER_recognizer_directive_bytefield(RTS_RTObject _SL) {
        super(_SL);
    ...
    @Override
    public CLASS_SCANNER_recognizer_directive_bytefield _STM() {
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("CLASS_SCANNER.sim","5 bytefield",1,655,12,656,15,655,28,657,31,658,34,660,39,661,44,662);
} // End of Procedure
