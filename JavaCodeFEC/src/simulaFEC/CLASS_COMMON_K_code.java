...
public final class CLASS_COMMON_K_code extends RTS_PROCEDURE {
...
public Object _RESULT() { return(_RESULT); }
    ...
    @Override
    public CLASS_COMMON_K_code setPar(Object param) {
        try {
            switch(_nParLeft--) {
    ...
    public CLASS_COMMON_K_code(RTS_RTObject _SL) {
        super(_SL,1); // Expecting 1 parameters
    }
    // Normal Constructor
    public CLASS_COMMON_K_code(RTS_RTObject _SL,char sp_k) {
        super(_SL);
    ...
    @Override
    public CLASS_COMMON_K_code _STM() {
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("CLASS_COMMON.sim","5 K_code",1,167,42,169,46,170,50,171,54,172,58,173,62,174,66,175,70,176,74,177,78,178,82,179,86,180,90,181,94,182,98,183,117,184);
} // End of Procedure
