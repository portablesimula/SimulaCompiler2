...
public final class CLASS_SCODER0_codegenerator0_ED_TYPE extends RTS_PROCEDURE {
...
public Object _RESULT() { return(_RESULT); }
    ...
    @Override
    public CLASS_SCODER0_codegenerator0_ED_TYPE setPar(Object param) {
        try {
            switch(_nParLeft--) {
    ...
    public CLASS_SCODER0_codegenerator0_ED_TYPE(RTS_RTObject _SL) {
        super(_SL,1); // Expecting 1 parameters
    }
    // Normal Constructor
    public CLASS_SCODER0_codegenerator0_ED_TYPE(RTS_RTObject _SL,int sp_ttag) {
        super(_SL);
    ...
    @Override
    public CLASS_SCODER0_codegenerator0_ED_TYPE _STM() {
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("CLASS_SCODER0.sim","5 ED_TYPE",1,288,42,290,45,291,47,292,51,293,55,294,59,295,63,296,67,297,71,298,75,299,79,300,83,301,87,302,91,303,95,304,99,305,107,307);
} // End of Procedure
