...
public class CLASS_CHECKER1_semchecker1_nextargumentproducer extends RTS_CLASS {
    // ClassDeclaration: Kind=9, BlockLevel=3, PrefixLevel=0, firstLine=1949, lastLine=2109, hasLocalClasses=false, System=false, detachUsed=true
public boolean isDetachUsed() { return(true); }
    // Declare parameters as attributes
    // Declare local labels
    // JavaLine 11 <== SourceLine 2005
    final RTS_LABEL _LABEL_CLASS_CHECKER1_semchecker1_nextargumentproducer_Block1977_Block2003_dummy_0=new RTS_LABEL(this,0,1,"dummy"); // Local Label #1=dummy At PrefixLevel 0
    // JavaLine 13 <== SourceLine 2021
    final RTS_LABEL _LABEL_CLASS_CHECKER1_semchecker1_nextargumentproducer_Block1977_Block2017_GENINDEX_0=new RTS_LABEL(this,0,2,"GENINDEX"); // Local Label #2=GENINDEX At PrefixLevel 0
    // JavaLine 15 <== SourceLine 2065
    final RTS_LABEL _LABEL_CLASS_CHECKER1_semchecker1_nextargumentproducer_Block1977_Block2037_Block2053_Block2057_enter_0=new RTS_LABEL(this,0,3,"enter"); // Local Label #3=enter At PrefixLevel 0
    ...
    public CLASS_CHECKER1_semchecker1_nextargumentproducer pred=null;
    public CLASS_CHECKER1_semchecker1_nextargumentproducer suc=null;
    // JavaLine 33 <== SourceLine 1962
    public CLASS_CHECKER1_semchecker1_identifier ident=null;
    // JavaLine 35 <== SourceLine 1963
    public CLASS_CHECKER1_semchecker1_argument firstarg=null;
    public CLASS_CHECKER1_semchecker1_argument lastarg=null;
    // JavaLine 38 <== SourceLine 1964
    public CLASS_COMMON_quantity testquant=null;
    // JavaLine 40 <== SourceLine 1966
    public CLASS_CHECKER1_semchecker1_parameter newpar=null;
    public CLASS_CHECKER1_semchecker1_index newindex=null;
    // JavaLine 43 <== SourceLine 1967
    public CLASS_COMMON_quantity cquant=null;
    public CLASS_COMMON_brecord cbrec=null;
    // JavaLine 46 <== SourceLine 1968
    public RTS_REF_ARRAY<CLASS_COMMON_quantity> prefixChain=null;
    // Normal Constructor
    public CLASS_CHECKER1_semchecker1_nextargumentproducer(RTS_RTObject staticLink) {
        super(staticLink);
    ...
    // Class Statements
    @Override
    public CLASS_CHECKER1_semchecker1_nextargumentproducer _STM() {
        CLASS_CHECKER1_semchecker1_nextargumentproducer _THIS=(CLASS_CHECKER1_semchecker1_nextargumentproducer)_CUR;
        _LOOP:while(_JTX>=0) {
            try {
                _JUMPTABLE(_JTX,3); // For ByteCode Engineering
                // JavaLine 63 <== SourceLine 1971
                new CLASS_COMMON_TRC((_CUR._SL._SL),new RTS_TXT("CHECKER1"),1971,new RTS_TXT("NEW   NEXTARGUMENTPRODUCER"));
                ;
                // JavaLine 66 <== SourceLine 1972
                pred=((CLASS_CHECKER1_semchecker1)(_CUR._SL)).lastnap_2;
                ;
                // JavaLine 69 <== SourceLine 1973
                firstarg=new CLASS_CHECKER1_semchecker1_argument((_CUR._SL),0,null)._STM();
                ;
                ...
                while(true) {
                    {
                        ...
                        ident=((CLASS_CHECKER1_semchecker1_identifier)(((CLASS_CHECKER1_semchecker1)(_CUR._SL)).exptop_2));
                        ;
                        kind=ident.kind;
                        ;
                        inuse=true;
                        ...
                        new CLASS_COMMON_QTRC((_CUR._SL._SL),new RTS_TXT("CHECKER1"),1996,new RTS_TXT("NEXT   NEXTARGUMENTPRODUCER  testquant on next line:"),testquant);
                        ;
                        ...
                        if(_VALUE((testquant==(null)))) {
                            {
                                ...
                                {
                                    _SIM_LABEL(1); // DeclaredIn: nextargumentproducer -> nextargumentproducer[CLASS_CHECKER1_semchecker1_nextargumentproducer] DeclarationKind=Class
                                    while(inuse) {
                                        {
                                            ...
                                            newpar=new CLASS_CHECKER1_semchecker1_parameter((_CUR._SL),argno,((CLASS_CHECKER1_semchecker1)(_CUR._SL)).exptop_2,null)._STM();
                                            ;
                            ...
                            switch(testquant.kind_1) { // BEGIN SWITCH STATEMENT
                                ...
                                // JavaLine 159 <== SourceLine 2016
                                {
                                    ...
                                    {
                                        _SIM_LABEL(2); // DeclaredIn: nextargumentproducer -> nextargumentproducer[CLASS_CHECKER1_semchecker1_nextargumentproducer] DeclarationKind=Class
                                        while(inuse) {
                                            {
                                                ...
                                                newindex=new CLASS_CHECKER1_semchecker1_index((_CUR._SL),argno,((CLASS_CHECKER1_semchecker1)(_CUR._SL)).exptop_2)._STM();
                                                ;
                                ...
                                // JavaLine 193 <== SourceLine 2033
                                {
                                    ...
                                    noofexpargs=1;
                                    ;
                                    _GOTO(_LABEL_CLASS_CHECKER1_semchecker1_nextargumentproducer_Block1977_Block2017_GENINDEX_0); // GOTO EVALUATED LABEL
                                }
                                break;
                                default:
                                // JavaLine 202 <== SourceLine 2036
                                {
                                    ...
                                    while((((count>(0))&&((preflvl!=(0))))&&(inuse))) {
                                        // JavaLine 234 <== SourceLine 2052
                                        {
                                            ...
                                            _GOTO(_LABEL_CLASS_CHECKER1_semchecker1_nextargumentproducer_Block1977_Block2037_Block2053_Block2057_enter_0); // GOTO EVALUATED LABEL
                                            ;
                                            ...
                                            while(((cquant!=(null))&&(inuse))) {
                                                {
                                                    ...
                                                    newpar=new CLASS_CHECKER1_semchecker1_parameter((_CUR._SL),argno,((CLASS_CHECKER1_semchecker1)(_CUR._SL)).exptop_2,cquant)._STM();
                                                    ;
                                                    // JavaLine 258 <== SourceLine 2059
                                                    if(_VALUE((((CLASS_CHECKER1_semchecker1)(_CUR._SL)).exptop_2.p_ch==('[')))) {
                                                        ;
                                                    } else {
                                                    ...
                                                    cquant=((CLASS_COMMON_quantity)(cquant.next));
                                                    ;
                                                    // JavaLine 280 <== SourceLine 2065
                                                    {
                                                        _SIM_LABEL(3); // DeclaredIn: nextargumentproducer -> nextargumentproducer[CLASS_CHECKER1_semchecker1_nextargumentproducer] DeclarationKind=Class
                                    ...
                                    if(_VALUE(inuse)) {
                                        {
                                            if(_VALUE((count==(0)))) {
                                                _GOTO(_LABEL_CLASS_CHECKER1_semchecker1_nextargumentproducer_Block1977_Block2003_dummy_0); // GOTO EVALUATED LABEL
                                            }
                                        }
                                    }
                                    ;
                                    ...
                                    if(_VALUE(((testquant.kind_1==(((char)1)))&&((testquant.dim_1==(RTS_ENVIRONMENT.rank('L'))))))) {
                                        ...
                                        new CLASS_CHECKER1_semchecker1_nextargumentproducer_Block1977_Block2037_Block2081((_CUR))._STM();
                                    }
                                    ;
                                }
                                break;
                ...
                // BEGIN nextargumentproducer INNER PART
                // ENDOF nextargumentproducer INNER PART
                break _LOOP;
            }
            catch(RTS_LABEL q) {
