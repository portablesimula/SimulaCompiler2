...
public Object _RESULT() { return(_RESULT); }
    ...
    final RTS_LABEL _LABEL_CLASS_CHECKER1_semchecker1_operation_sameAs_Block209_Block212_CR_0=new RTS_LABEL(this,0,1,"CR"); // Local Label #1=CR At PrefixLevel 0
    // Declare locals as attributes
    // JavaLine 16 <== SourceLine 205
    public boolean _RESULT=false;
    // Parameter Transmission in case of Formal/Virtual Procedure Call
    @Override
    public CLASS_CHECKER1_semchecker1_operation_sameAs setPar(Object param) {
        try {
            switch(_nParLeft--) {
    ...
    public CLASS_CHECKER1_semchecker1_operation_sameAs(RTS_RTObject _SL) {
        super(_SL,1); // Expecting 1 parameters
    }
    // Normal Constructor
    public CLASS_CHECKER1_semchecker1_operation_sameAs(RTS_RTObject _SL,CLASS_CHECKER1_semchecker1_exp sp_e) {
        super(_SL);
    ...
    @Override
    public CLASS_CHECKER1_semchecker1_operation_sameAs _STM() {
        CLASS_CHECKER1_semchecker1_operation_sameAs _THIS=(CLASS_CHECKER1_semchecker1_operation_sameAs)_CUR;
        _LOOP:while(_JTX>=0) {
            try {
                _JUMPTABLE(_JTX,1); // For ByteCode Engineering
                // JavaLine 50 <== SourceLine 208
                if(_VALUE(p_e instanceof CLASS_CHECKER1_semchecker1_operation)) {
                    {
                        // JavaLine 53 <== SourceLine 209
                        if(_VALUE((((CLASS_CHECKER1_semchecker1_operation)(_CUR._SL)).p1_left==(null)))) {
                            {
                                // JavaLine 56 <== SourceLine 210
                                if(_VALUE((((CLASS_CHECKER1_semchecker1_operation)(p_e)).p1_left==(null)))) {
                                    _GOTO(_LABEL_CLASS_CHECKER1_semchecker1_operation_sameAs_Block209_Block212_CR_0); // GOTO EVALUATED LABEL
                                }
                            }
                        } else {
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("CLASS_CHECKER1.sim","5 sameAs",1,205,13,213,16,205,50,208,53,209,56,210,62,211,65,212,67,213,90,216);
} // End of Procedure
