...
public class CLASS_COMMON_outcodefile extends RTS_Outbytefile {
    // ClassDeclaration: Kind=9, BlockLevel=2, PrefixLevel=3, firstLine=866, lastLine=869, hasLocalClasses=false, System=false, detachUsed=false
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("CLASS_COMMON.sim","9 outcodefile",1,866,10,867,24,868,29,869,37,869);
} // End of Class
