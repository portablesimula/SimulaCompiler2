...
public class CLASS_PARSER_grammer_forstat extends CLASS_PARSER_grammer_statement {
    // ClassDeclaration: Kind=8, BlockLevel=3, PrefixLevel=1, firstLine=1432, lastLine=1696, hasLocalClasses=false, System=false, detachUsed=true
