...
public final class CLASS_BUILDER2_normalattrfile_expandextlist extends RTS_PROCEDURE {
    ...
    public CLASS_COMMON_extbrecord p_module;
    public CLASS_COMMON_brecord p_encl;
    // Declare local labels
    // JavaLine 12 <== SourceLine 252
    final RTS_LABEL _LABEL_CLASS_BUILDER2_normalattrfile_expandextlist_Block247_Block252_GENQ_0=new RTS_LABEL(this,0,1,"GENQ"); // Local Label #1=GENQ At PrefixLevel 0
    // JavaLine 14 <== SourceLine 260
    final RTS_LABEL _LABEL_CLASS_BUILDER2_normalattrfile_expandextlist_Block247_Block252_GENOQ_0=new RTS_LABEL(this,0,2,"GENOQ"); // Local Label #2=GENOQ At PrefixLevel 0
    // JavaLine 16 <== SourceLine 293
    final RTS_LABEL _LABEL_CLASS_BUILDER2_normalattrfile_expandextlist_Block247_Block252_ExpDescr_0=new RTS_LABEL(this,0,3,"ExpDescr"); // Local Label #3=ExpDescr At PrefixLevel 0
    // JavaLine 18 <== SourceLine 312
    final RTS_LABEL _LABEL_CLASS_BUILDER2_normalattrfile_expandextlist_EXIT_0=new RTS_LABEL(this,0,4,"EXIT"); // Local Label #4=EXIT At PrefixLevel 0
    // Declare locals as attributes
    // JavaLine 21 <== SourceLine 234
    public CLASS_COMMON_extquantity cq=null;
    public CLASS_COMMON_extquantity lq=null;
    public int overload=0;
    // JavaLine 25 <== SourceLine 235
    public boolean genqnt=false;
    // JavaLine 27 <== SourceLine 293
    public CLASS_COMMON_brecord _inspect_293_4535=null;
    // Parameter Transmission in case of Formal/Virtual Procedure Call
    @Override
    public CLASS_BUILDER2_normalattrfile_expandextlist setPar(Object param) {
        try {
            switch(_nParLeft--) {
                case 2: p_module=(CLASS_COMMON_extbrecord)objectValue(param); break;
                case 1: p_encl=(CLASS_COMMON_brecord)objectValue(param); break;
    ...
    public CLASS_BUILDER2_normalattrfile_expandextlist(RTS_RTObject _SL) {
        super(_SL,2); // Expecting 2 parameters
    }
    // Normal Constructor
    public CLASS_BUILDER2_normalattrfile_expandextlist(RTS_RTObject _SL,CLASS_COMMON_extbrecord sp_module,CLASS_COMMON_brecord sp_encl) {
        super(_SL);
    ...
    @Override
    public CLASS_BUILDER2_normalattrfile_expandextlist _STM() {
        CLASS_BUILDER2_normalattrfile_expandextlist _THIS=(CLASS_BUILDER2_normalattrfile_expandextlist)_CUR;
        _LOOP:while(_JTX>=0) {
            try {
                ...
                while((((CLASS_BUILDER2_normalattrfile)(_CUR._SL)).key<(((char)240)))) {
                    {
                        ...
                        genqnt=new CLASS_COMMON_attrfile_fetchquant((_CUR._SL))._RESULT;
                        ;
                        ...
                        if(_VALUE((overload>(0)))) {
                            // JavaLine 80 <== SourceLine 250
                            {
                                overload=(overload-(1));
                                ;
                                _GOTO(_LABEL_CLASS_BUILDER2_normalattrfile_expandextlist_Block247_Block252_GENOQ_0); // GOTO EVALUATED LABEL
                            }
                        }
                        ;
                        ...
                        if(_VALUE(genqnt)) {
                            {
                                    ...
                                    if(_VALUE((((CLASS_BUILDER2_normalattrfile)(_CUR._SL)).xlongindic!=(((char)0))))) {
                                        {
                                            ...
                                            overload=RTS_ENVIRONMENT.rank(((CLASS_BUILDER2_normalattrfile)(_CUR._SL)).xlongindic);
                                            ;
                                            ...
                                            if(_VALUE((((CLASS_BUILDER2_normalattrfile)(_CUR._SL)).xclf==(((char)5))))) {
                                ...
                                new CLASS_BUILDER2_normalattrfile_fillextquantity((_CUR._SL),cq);
                                ;
                                ...
                                if(_VALUE((cq.categ_1!=(((char)6))))) {
                                    {
                                        ...
                                        if(_VALUE((p_encl.fpar==(null)))) {
                                            ...
                                            if(_VALUE((lq!=(null)))) {
                                                lq=((CLASS_COMMON_extquantity)(lq.next=cq));
                                            }
                                        }
                                        ;
                                        // JavaLine 144 <== SourceLine 273
                                        new CLASS_COMMON_TRC((_CUR._SL._SL),new RTS_TXT("BUILDER2"),273,CONC(CONC(CONC(CONC(new RTS_TXT("CHECK PAR-3 "),cq.symb_1.symbol),new RTS_TXT(" ")),new RTS_TXT("cq.categ=")),new CLASS_COMMON_C_code((_CUR._SL._SL),cq.categ_1)._RESULT));
                                        ;
                                        ...
                                        if(_VALUE(((cq.categ_1!=(((char)3)))&&((cq.categ_1!=(((char)4))))))) {
                                            // JavaLine 149 <== SourceLine 276
                                            {
                                                ...
                                                new CLASS_COMMON_QTRC((_CUR._SL._SL),new RTS_TXT("BUILDER2"),277,CONC(CONC(CONC(new RTS_TXT("NPAR+1: "),p_encl.declquant.symb_1.symbol),new RTS_TXT(".npar=")),RTS_ENVIRONMENT.edit(p_encl.npar)),cq);
                                                ;
                                    ...
                                    // JavaLine 167 <== SourceLine 282
                                    {
                                        ...
                                        if(_VALUE((((CLASS_BUILDER2_normalattrfile)(_CUR._SL)).key==(((char)251))))) {
                                            _GOTO(_LABEL_CLASS_BUILDER2_normalattrfile_expandextlist_Block247_Block252_ExpDescr_0); // GOTO EVALUATED LABEL
                                        }
                                        ;
                                    }
                                }
                                ...
                                if(_VALUE((((cq.categ_1==(((char)3)))||(((cq.categ_1==(((char)4)))&&((cq.descr_1==(null))))))&&(((cq.kind_1==(((char)1)))||((cq.kind_1==(((char)5))))))))) {
                                    // JavaLine 187 <== SourceLine 293
                                    {
                                        _SIM_LABEL(3); // DeclaredIn: expandextlist -> expandextlist[externalIdent=CLASS_BUILDER2_normalattrfile_expandextlist] Kind=5, QUAL=ProcedureDeclaration, HashCode=273479239
                                        {
                                            ...
                                            if(_inspect_293_4535!=null) { // INSPECT _inspect_293_4535  type=ref(BRECORD)
                                                // JavaLine 194 <== SourceLine 294
                                                {
                                                    // JavaLine 196 <== SourceLine 293
                                                    {
                                                        ...
                                                        cq.descr_1=((CLASS_COMMON_brecord)_inspect_293_4535);
                                                        ;
                                                        _inspect_293_4535.declquant=cq;
                                                        ;
                                                        _inspect_293_4535.kind=((CLASS_BUILDER2_normalattrfile)(_CUR._SL)).xkind;
                                                        ;
                                                        // JavaLine 211 <== SourceLine 297
                                                        _inspect_293_4535.thisused=((CLASS_BUILDER2_normalattrfile)(_CUR._SL)).xthisused;
                                                        ;
                                                        // JavaLine 214 <== SourceLine 300
                                                        _inspect_293_4535.inrtag=((CLASS_BUILDER2_normalattrfile)(_CUR._SL)).xinrtag;
                                                        ;
                                                        _inspect_293_4535.hasCode=((CLASS_BUILDER2_normalattrfile)(_CUR._SL)).xhascode;
                                                        ;
                                                        // JavaLine 219 <== SourceLine 302
                                                        if(_VALUE((((CLASS_BUILDER2_normalattrfile)(_CUR._SL)).key==(((char)251))))) {
                                                            // JavaLine 221 <== SourceLine 303
                                                            new CLASS_BUILDER2_normalattrfile_expandextlist((_CUR._SL),p_module,((CLASS_COMMON_brecord)_inspect_293_4535));
                                                        }
                                                        ;
                                                        // JavaLine 225 <== SourceLine 304
                                                        new CLASS_COMMON_QTRC((_CUR._SL._SL),new RTS_TXT("BUILDER2"),304,new RTS_TXT("NEW BRECORD "),_inspect_293_4535.declquant);
                                                        ;
                                                    }
                                                }
                                            }
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("CLASS_BUILDER2.sim","5 expandextlist",1,232,12,252,14,260,16,293,18,312,21,234,25,235,27,293,63,240,66,242,69,243,72,245,75,247,78,249,80,250,88,251,91,252,96,253,99,254,104,256,106,257,112,259,119,260,125,265,128,267,131,268,134,269,138,270,144,273,147,274,149,276,151,277,154,278,160,280,167,282,169,283,173,284,177,286,185,289,187,293,194,294,196,293,198,294,201,295,204,296,211,297,214,300,219,302,221,303,225,304,237,308,246,312,254,313,257,314,269,317);
} // End of Procedure
