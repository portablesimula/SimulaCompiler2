...
public final class CLASS_SCODER2_codegenerator2_outdescriptors extends RTS_PROCEDURE {
    ...
    final RTS_LABEL _LABEL_CLASS_SCODER2_codegenerator2_outdescriptors_Block992_DESCRGEN_0=new RTS_LABEL(this,0,1,"DESCRGEN"); // Local Label #1=DESCRGEN At PrefixLevel 0
    // Declare locals as attributes
    // JavaLine 14 <== SourceLine 930
    public CLASS_COMMON_quantity qty=null;
    public RTS_TXT txt=null;
    // JavaLine 17 <== SourceLine 936
    public CLASS_COMMON_extbrecord _inspect_936_4643=null;
    // Parameter Transmission in case of Formal/Virtual Procedure Call
    @Override
    public CLASS_SCODER2_codegenerator2_outdescriptors setPar(Object param) {
        try {
            switch(_nParLeft--) {
    ...
    public CLASS_SCODER2_codegenerator2_outdescriptors(RTS_RTObject _SL) {
        super(_SL,1); // Expecting 1 parameters
    }
    // Normal Constructor
    public CLASS_SCODER2_codegenerator2_outdescriptors(RTS_RTObject _SL,CLASS_COMMON_quantity sp_q) {
        super(_SL);
    ...
    @Override
    public CLASS_SCODER2_codegenerator2_outdescriptors _STM() {
        CLASS_SCODER2_codegenerator2_outdescriptors _THIS=(CLASS_SCODER2_codegenerator2_outdescriptors)_CUR;
        _LOOP:while(_JTX>=0) {
            try {
                ...
                if(_VALUE((p_q.categ_1==(((char)4))))) {
                    {
                        ...
                        if(_VALUE((((CLASS_COMMON_extquantity)(p_q)).clf_2==(((char)0))))) {
                            {
                                // JavaLine 57 <== SourceLine 934
                                ((CLASS_SCODER2_codegenerator2)(_CUR._SL)).outbyte(115);
                                ;
                                // JavaLine 60 <== SourceLine 936
                                {
                                    // BEGIN INSPECTION 
                                    _inspect_936_4643=((CLASS_COMMON_extquantity)(p_q)).p2_module;
                                    if(_inspect_936_4643!=null) { // INSPECT _inspect_936_4643  type=ref(EXTBRECORD)
                                        // JavaLine 65 <== SourceLine 937
                                        {
                                            // JavaLine 67 <== SourceLine 936
                                            new CLASS_SCODER2_codegenerator2_outdescriptors_Block932_Block934_Block937((_CUR))._STM();
                                        }
                                    }
                                } // END INSPECTION
                            }
                            ...
                            if(_VALUE((((CLASS_COMMON_extquantity)(p_q)).clf_2==(((char)1))))) {
                                // JavaLine 76 <== SourceLine 956
                                new CLASS_SCODER2_codegenerator2_profilegenerator((_CUR._SL),((CLASS_COMMON_extquantity)(p_q)));
                            }
                        }
                        ;
                    }
                    ...
                    switch(p_q.kind_1) { // BEGIN SWITCH STATEMENT
                        ...
                        // JavaLine 87 <== SourceLine 959
                        {
                            ...
                            new CLASS_SCODER0_codegenerator0_STRC3((_CUR._SL),new RTS_TXT("SCODER2"),961,new RTS_TXT("CONSTSPEC"),CONC(CONC(new CLASS_SCODER0_codegenerator0_ED_TAG((_CUR._SL),(p_q.ftag_1+(1)))._RESULT,new RTS_TXT("  ")),new CLASS_SCODER0_codegenerator0_ED_TTAG((_CUR._SL),new RTS_TXT("\u0000Y"))._RESULT));
                            ;
                            // JavaLine 95 <== SourceLine 962
                            new CLASS_SCODER0_codegenerator0_STRC3((_CUR._SL),new RTS_TXT("SCODER2"),962,new RTS_TXT("LABELSPEC"),new CLASS_SCODER0_codegenerator0_ED_TAG((_CUR._SL),(p_q.ftag_1+(2)))._RESULT);
                            ;
                            // JavaLine 98 <== SourceLine 963
                            ((CLASS_SCODER2_codegenerator2)(_CUR._SL)).outbyte(52);
                            ;
                            new CLASS_SCODER0_codegenerator0_outtag((_CUR._SL),(p_q.ftag_1+(1)));
                            ;
                            // JavaLine 103 <== SourceLine 964
                            ((CLASS_SCODER2_codegenerator2)(_CUR._SL)).outtext(CONC(new RTS_TXT("\u0000Y"),new RTS_TXT("/")));
                            ;
                            ...
                            if(_VALUE((p_q.plev_1<(2)))) {
                                {
                                    ...
                                    new CLASS_SCODER0_codegenerator0_STRC3((_CUR._SL),new RTS_TXT("SCODER2"),970,new RTS_TXT("CONSTSPEC"),CONC(CONC(new CLASS_SCODER0_codegenerator0_ED_TAG((_CUR._SL),(p_q.ftag_1+(1)))._RESULT,new RTS_TXT("  ")),new CLASS_SCODER0_codegenerator0_ED_TAG((_CUR._SL),91)._RESULT));
                                    ;
                                    ...
                                    new CLASS_SCODER0_codegenerator0_outTagWithIdent((_CUR._SL),91);
                                    ;
                                            ...
                                            if(_VALUE((qty.categ_1==(((char)2))))) {
                                                {
                                                    ...
                                                    new CLASS_SCODER0_codegenerator0_STRC3((_CUR._SL),new RTS_TXT("SCODER2"),982,new RTS_TXT("CONSTSPEC"),CONC(CONC(new CLASS_SCODER0_codegenerator0_ED_TAG((_CUR._SL),(qty.ftag_1+(1)))._RESULT,new RTS_TXT("  ")),new CLASS_SCODER0_codegenerator0_ED_TAG((_CUR._SL),((((qty.type_1==(((char)7)))||((qty.type_1==(((char)9))))))?(130):(124)))._RESULT));
                                                    ;
                                                    // JavaLine 143 <== SourceLine 983
                                                    ((CLASS_SCODER2_codegenerator2)(_CUR._SL)).outbyte(52);
                                                    ;
                                                    // JavaLine 146 <== SourceLine 984
                                                    new CLASS_SCODER0_codegenerator0_outTagWithIdent((_CUR._SL),(qty.ftag_1+(1)));
                                                    ;
                                                    // JavaLine 149 <== SourceLine 985
                                                    new CLASS_SCODER0_codegenerator0_outTagWithIdent((_CUR._SL),((((qty.type_1==(((char)7)))||((qty.type_1==(((char)9))))))?(130):(124)));
                                                    ;
                                                }
                                            }
                                            ;
                            ...
                            if(_VALUE((p_q.plev_1>(1)))) {
                                {
                                    ...
                                    if(_VALUE(RTS_UTIL._IS(p_q.prefqual_1,CLASS_COMMON_quantity.class))) {
                                        {
                                            // JavaLine 179 <== SourceLine 996
                                            if(_VALUE((!(p_q.prefqual_1.descr_1.descriptorpr)))) {
                                                // JavaLine 181 <== SourceLine 997
                                                new CLASS_SCODER2_codegenerator2_outdescriptors((_CUR._SL),p_q.prefqual_1);
                                            }
                                        }
                                    }
                                }
                            ...
                            if(_VALUE((p_q.descr_1.inrtag!=(((char)0))))) {
                                {
                                    ...
                                    new CLASS_SCODER0_codegenerator0_STRC3((_CUR._SL),new RTS_TXT("SCODER2"),1005,new RTS_TXT("LABELSPEC"),new CLASS_SCODER0_codegenerator0_ED_TAG((_CUR._SL),(p_q.ftag_1+(RTS_ENVIRONMENT.isorank(p_q.descr_1.inrtag))))._RESULT);
                                    ;
                                    // JavaLine 215 <== SourceLine 1006
                                    ((CLASS_SCODER2_codegenerator2)(_CUR._SL)).outbyte(47);
                                    ;
                        ...
                        _GOTO(_LABEL_CLASS_SCODER2_codegenerator2_outdescriptors_Block992_DESCRGEN_0); // GOTO EVALUATED LABEL
                        break;
                ...
                while((p_q!=(null))) {
                    {
                        ...
                        if(_VALUE(((p_q.kind_1==(((char)5)))&&(p_q.descr_1.descriptorpr)))) {
                            ...
                            if(_VALUE((RTS_UTIL._IS(p_q,CLASS_COMMON_extquantity.class)&&((p_q.categ_1!=(((char)4))))))) {
                                ;
                            } else {
                                ...
                                if(_VALUE(((((p_q.kind_1==(((char)1)))||((p_q.kind_1==(((char)5)))))||((p_q.kind_1==(((char)7)))))&&(((p_q.categ_1==(((char)3)))||((p_q.categ_1==(((char)4))))))))) {
                                    ...
                                    new CLASS_SCODER2_codegenerator2_outdescriptors((_CUR._SL),p_q);
                                } else {
                                                ...
                                                if(_VALUE((p_q.kind_1==(((char)4))))) {
                                                    {
                                                        ...
                                                        ((CLASS_SCODER2_codegenerator2)(_CUR._SL)).out2byte((p_q.dim_1+(1)));
                                                        ;
                                                    }
                                                } else {
                                                                ...
                                                                // JavaLine 291 <== SourceLine 1037
                                                                {
                                                                    if(_VALUE((p_q.type_1==(((char)8))))) {
                                                                        // JavaLine 294 <== SourceLine 1038
                                                                        {
                                                                            ...
                                                                            ((CLASS_SCODER2_codegenerator2)(_CUR._SL)).outbyte(52);
                                                                            ;
                                                                            new CLASS_SCODER0_codegenerator0_outTagWithIdent((_CUR._SL),p_q.ftag_1);
                                                                            ;
                                                                            // JavaLine 301 <== SourceLine 1040
                                                                            new CLASS_SCODER0_codegenerator0_outTagWithIdent((_CUR._SL),313);
                                                                            ;
                                                                        }
                                                                    }
                                                                }
