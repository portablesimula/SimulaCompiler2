...
public final class CLASS_ERRMSG_fatal0 extends RTS_PROCEDURE {
    // ProcedureDeclaration: Kind=5, BlockLevel=2, firstLine=310, lastLine=310, hasLocalClasses=false, System=false
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("CLASS_ERRMSG.sim","5 fatal0",1,310,42,310);
} // End of Procedure
