...
public class CLASS_PARSER_codebuffer_elt extends RTS_CLASS {
    // ClassDeclaration: Kind=9, BlockLevel=3, PrefixLevel=0, firstLine=51, lastLine=66, hasLocalClasses=false, System=false, detachUsed=false
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("CLASS_PARSER.sim","9 elt",1,51,10,52,15,53,27,66,32,66);
} // End of Class
