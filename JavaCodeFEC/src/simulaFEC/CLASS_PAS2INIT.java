...
public class CLASS_PAS2INIT extends CLASS_SCODER4 {
    // ClassDeclaration: Kind=9, BlockLevel=1, PrefixLevel=16, firstLine=3, lastLine=658, hasLocalClasses=true, System=false, detachUsed=false
    // Declare parameters as attributes
    // Declare locals as attributes
    // Normal Constructor
    public CLASS_PAS2INIT(RTS_RTObject staticLink) {
        super(staticLink);
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("CLASS_PAS2INIT.sim","9 CLASS_PAS2INIT",1,3,19,1323,21,993,23,2395,25,89,27,2698,29,262,32,265,34,802,36,1887,38,2636,40,1664,42,311,44,903,46,375,48,1255,50,1448,52,499,54,658,75,658);
} // End of Class
