...
public class CLASS_SCODMAIN extends CLASS_PAS2INIT {
    // ClassDeclaration: Kind=9, BlockLevel=1, PrefixLevel=17, firstLine=3, lastLine=3455, hasLocalClasses=true, System=false, detachUsed=false
    // Declare parameters as attributes
    // Declare locals as attributes
    // Normal Constructor
    public CLASS_SCODMAIN(RTS_RTObject staticLink) {
        super(staticLink);
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("CLASS_SCODMAIN.sim","9 CLASS_SCODMAIN",1,3,19,1323,21,993,23,2395,25,89,27,2698,29,262,32,265,34,802,36,1887,38,2636,40,1664,42,311,44,903,46,375,48,1255,50,1448,52,499,54,658,56,3455,78,3455);
} // End of Class
