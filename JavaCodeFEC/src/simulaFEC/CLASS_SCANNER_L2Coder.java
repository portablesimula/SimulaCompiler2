...
public class CLASS_SCANNER_L2Coder extends CLASS_COMMON_outcodefile {
    // ClassDeclaration: Kind=9, BlockLevel=2, PrefixLevel=4, firstLine=1558, lastLine=2382, hasLocalClasses=false, System=false, detachUsed=true
