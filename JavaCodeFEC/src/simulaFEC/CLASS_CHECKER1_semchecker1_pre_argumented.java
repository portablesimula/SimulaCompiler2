...
public class CLASS_CHECKER1_semchecker1_pre_argumented extends CLASS_CHECKER1_semchecker1_exp {
    // ClassDeclaration: Kind=9, BlockLevel=3, PrefixLevel=1, firstLine=1720, lastLine=1778, hasLocalClasses=false, System=false, detachUsed=false
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("CLASS_CHECKER1.sim","9 pre_argumented",1,1720,29,169,31,1778,37,1778);
} // End of Class
