...
public class CLASS_COMMON extends RTS_CLASS {
    // ClassDeclaration: Kind=9, BlockLevel=1, PrefixLevel=0, firstLine=1, lastLine=1323, hasLocalClasses=true, System=false, detachUsed=false
