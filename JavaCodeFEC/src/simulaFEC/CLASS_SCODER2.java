...
public class CLASS_SCODER2 extends CLASS_SCODER1E {
    // ClassDeclaration: Kind=9, BlockLevel=1, PrefixLevel=13, firstLine=3, lastLine=1255, hasLocalClasses=true, System=false, detachUsed=false
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("CLASS_SCODER2.sim","9 CLASS_SCODER2",1,3,19,1323,21,993,23,2395,25,89,27,2698,29,262,32,265,34,802,36,1887,38,2636,40,1664,42,311,44,903,46,375,48,1255,66,1255);
} // End of Class
