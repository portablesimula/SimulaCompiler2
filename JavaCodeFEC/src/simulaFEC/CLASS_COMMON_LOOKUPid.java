...
public final class CLASS_COMMON_LOOKUPid extends RTS_PROCEDURE {
...
public Object _RESULT() { return(_RESULT); }
    ...
    final RTS_LABEL _LABEL_CLASS_COMMON_LOOKUPid_Block117_F_0=new RTS_LABEL(this,0,1,"F"); // Local Label #1=F At PrefixLevel 0
    ...
    // Normal Constructor
    public CLASS_COMMON_LOOKUPid(RTS_RTObject _SL) {
        super(_SL);
    ...
    @Override
    public CLASS_COMMON_LOOKUPid _STM() {
        CLASS_COMMON_LOOKUPid _THIS=(CLASS_COMMON_LOOKUPid)_CUR;
        _LOOP:while(_JTX>=0) {
            try {
                    ...
                    // JavaLine 44 <== SourceLine 114
                    {
                        ...
                        if(_VALUE((cursym!=(null)))) {
                                ...
                                while(RTS_UTIL._TXTREL_NE(cursym.symbol,((CLASS_COMMON)(_CUR._SL)).simsymbol)) {
                                    // JavaLine 57 <== SourceLine 122
                                    {
                                        ...
                                        if(_VALUE((cursym.next==(null)))) {
                                            _GOTO(_LABEL_CLASS_COMMON_LOOKUPid_Block117_F_0); // GOTO EVALUATED LABEL
                                        }
                                        ;
                            ...
                            // JavaLine 80 <== SourceLine 129
                            {
                                {
                                    _SIM_LABEL(1);
                                    ((CLASS_COMMON)(_CUR._SL)).hashhi=((char)0);
                                    ;
                                    _RESULT=false;
                                }
                            }
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("CLASS_COMMON.sim","5 LOOKUPid",1,110,12,129,15,111,18,110,35,112,37,113,44,114,46,117,49,118,52,119,55,120,57,122,59,123,64,124,70,126,75,127,80,129,103,131);
} // End of Procedure
