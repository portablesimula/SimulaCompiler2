...
public final class CLASS_BUILDER2_prechecker_allocate_alloc2_setprefix extends RTS_PROCEDURE {
    ...
    public CLASS_COMMON_quantity p_subq;
    // Declare local labels
    // JavaLine 11 <== SourceLine 1359
    final RTS_LABEL _LABEL_CLASS_BUILDER2_prechecker_allocate_alloc2_setprefix_Block1338_Block1350_Block1354_PrefErr_0=new RTS_LABEL(this,0,1,"PrefErr"); // Local Label #1=PrefErr At PrefixLevel 0
    // JavaLine 13 <== SourceLine 1370
    final RTS_LABEL _LABEL_CLASS_BUILDER2_prechecker_allocate_alloc2_setprefix_Block1338_Block1370_setPref_0=new RTS_LABEL(this,0,2,"setPref"); // Local Label #2=setPref At PrefixLevel 0
    // JavaLine 15 <== SourceLine 1379
    final RTS_LABEL _LABEL_CLASS_BUILDER2_prechecker_allocate_alloc2_setprefix_Block1338_out_0=new RTS_LABEL(this,0,3,"out"); // Local Label #3=out At PrefixLevel 0
    // Declare locals as attributes
    // JavaLine 18 <== SourceLine 1331
    public CLASS_COMMON_quantity PQ=null;
    public CLASS_COMMON_quantity smlblk=null;
    // JavaLine 21 <== SourceLine 1332
    public CLASS_COMMON_symbolbox symx=null;
    public int i=0;
    // Parameter Transmission in case of Formal/Virtual Procedure Call
    @Override
    public CLASS_BUILDER2_prechecker_allocate_alloc2_setprefix setPar(Object param) {
        try {
            switch(_nParLeft--) {
                case 1: p_subq=(CLASS_COMMON_quantity)objectValue(param); break;
    ...
    public CLASS_BUILDER2_prechecker_allocate_alloc2_setprefix(RTS_RTObject _SL) {
        super(_SL,1); // Expecting 1 parameters
    }
    // Normal Constructor
    public CLASS_BUILDER2_prechecker_allocate_alloc2_setprefix(RTS_RTObject _SL,CLASS_COMMON_quantity sp_subq) {
        super(_SL);
    ...
    @Override
    public CLASS_BUILDER2_prechecker_allocate_alloc2_setprefix _STM() {
        CLASS_BUILDER2_prechecker_allocate_alloc2_setprefix _THIS=(CLASS_BUILDER2_prechecker_allocate_alloc2_setprefix)_CUR;
        _LOOP:while(_JTX>=0) {
            try {
                ...
                if(_VALUE((((p_subq.kind_1!=(((char)5)))&((p_subq.kind_1!=(((char)7)))))|((p_subq.prefqual_1!=(null)))))) {
                    ...
                    new CLASS_ERRMSG_internerr((_CUR._SL._SL._SL._SL),((char)7),1336);
                } else {
                    // JavaLine 61 <== SourceLine 1337
                    {
                        // JavaLine 63 <== SourceLine 1338
                        p_subq.match_1=((CLASS_BUILDER2)(_CUR._SL._SL._SL._SL)).setprefgoing;
                        ;
                        ...
                        ;
                        PQ=new CLASS_BUILDER1_meaningof((_CUR._SL._SL._SL._SL),symx)._RESULT;
                        ;
                        // JavaLine 88 <== SourceLine 1343
                        if(_VALUE((PQ==(null)))) {
                            PQ=new CLASS_ERRMSG_newnotseen((_CUR._SL._SL._SL._SL),symx)._RESULT;
                        }
                        ;
                        // JavaLine 93 <== SourceLine 1344
                        if(_VALUE(((PQ.categ_1==(((char)5)))|(((PQ.kind_1!=(((char)5)))&((PQ.kind_1!=(((char)7))))))))) {
                            // JavaLine 95 <== SourceLine 1346
                            new CLASS_ERRMSG_errQTN((_CUR._SL._SL._SL._SL),p_subq,409,PQ);
                        } else {
                            // JavaLine 98 <== SourceLine 1347
                            if(_VALUE((PQ.encl_1.blev!=(p_subq.encl_1.blev)))) {
                                {
                                    // JavaLine 101 <== SourceLine 1350
                                    if(_VALUE(RTS_UTIL._IS(PQ,CLASS_COMMON_quantity.class))) {
                                        _GOTO(_LABEL_CLASS_BUILDER2_prechecker_allocate_alloc2_setprefix_Block1338_Block1350_Block1354_PrefErr_0); // GOTO EVALUATED LABEL
                                    }
                                    ;
                                    // JavaLine 106 <== SourceLine 1351
                                    if(_VALUE((((CLASS_COMMON_extquantity)(PQ)).clf_2==(((char)9))))) {
                                        {
                                            ...
                                            if(_VALUE((smlblk.symb_1!=(null)))) {
                                                {
                                                    ...
                                                    if(_VALUE(RTS_UTIL._TXTREL_EQ(smlblk.symb_1.symbol,new RTS_TXT("simulation")))) {
                                                        // JavaLine 122 <== SourceLine 1358
                                                        _GOTO(_LABEL_CLASS_BUILDER2_prechecker_allocate_alloc2_setprefix_Block1338_Block1370_setPref_0); // GOTO EVALUATED LABEL
                                                    }
                                                }
                                            }
                                            ;
                                        ...
                                        if(_VALUE((((CLASS_COMMON_extquantity)(PQ)).clf_2!=(((char)4))))) {
                                ...
                                if(_VALUE((PQ.match_1==(((CLASS_BUILDER2)(_CUR._SL._SL._SL._SL)).setprefgoing)))) {
                                    // JavaLine 150 <== SourceLine 1368
                                    new CLASS_ERRMSG_errQT((_CUR._SL._SL._SL._SL),p_subq,318);
                                } else {
                                    // JavaLine 153 <== SourceLine 1369
                                    {
                                            ...
                                            if(_VALUE((PQ.prefqual_1==(null)))) {
                                                {
                                                    ...
                                                    if(_VALUE(((PQ.ftag_1<(0))|((PQ.line_1<(0)))))) {
                                                        ...
                                                        new CLASS_BUILDER2_prechecker_allocate_alloc2_setprefix((_CUR._SL),PQ);
                                                    }
                                                }
                                            }
                                        }
                                        ...
                                        _GOTO(_LABEL_CLASS_BUILDER2_prechecker_allocate_alloc2_setprefix_Block1338_out_0); // GOTO EVALUATED LABEL
                                        ;
                                    }
                                }
                            }
