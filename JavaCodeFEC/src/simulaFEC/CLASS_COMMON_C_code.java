...
public final class CLASS_COMMON_C_code extends RTS_PROCEDURE {
...
public Object _RESULT() { return(_RESULT); }
    ...
    @Override
    public CLASS_COMMON_C_code setPar(Object param) {
        try {
            switch(_nParLeft--) {
    ...
    public CLASS_COMMON_C_code(RTS_RTObject _SL) {
        super(_SL,1); // Expecting 1 parameters
    }
    // Normal Constructor
    public CLASS_COMMON_C_code(RTS_RTObject _SL,char sp_k) {
        super(_SL);
    ...
    @Override
    public CLASS_COMMON_C_code _STM() {
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("CLASS_COMMON.sim","5 C_code",1,114,42,116,46,117,50,118,54,119,58,120,62,121,66,122,70,123,74,124,87,125);
} // End of Procedure
