...
public class CLASS_PARSER_grammer_expression extends RTS_CLASS {
    // ClassDeclaration: Kind=9, BlockLevel=3, PrefixLevel=0, firstLine=1949, lastLine=2233, hasLocalClasses=false, System=false, detachUsed=true
