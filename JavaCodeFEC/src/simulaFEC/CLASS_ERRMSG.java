...
public class CLASS_ERRMSG extends CLASS_COMMON {
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("CLASS_ERRMSG.sim","8 CLASS_ERRMSG",1,3,10,34,12,35,14,36,16,38,19,40,21,160,25,161,37,1323,39,998,45,998);
} // End of Class
