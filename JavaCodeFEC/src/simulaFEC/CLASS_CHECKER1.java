...
public class CLASS_CHECKER1 extends CLASS_BUILDER2 {
    // ClassDeclaration: Kind=9, BlockLevel=1, PrefixLevel=8, firstLine=3, lastLine=2636, hasLocalClasses=true, System=false, detachUsed=false
    // Declare parameters as attributes
    // Declare locals as attributes
    // Normal Constructor
    public CLASS_CHECKER1(RTS_RTObject staticLink) {
        super(staticLink);
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("CLASS_CHECKER1.sim","9 CLASS_CHECKER1",1,3,19,1323,21,993,23,2395,25,89,27,2698,29,262,32,265,34,802,36,1887,38,2636,51,2636);
} // End of Class
