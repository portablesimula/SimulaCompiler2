...
package simulaFEC;
// Simula-2.0 Compiled at Wed Jul 17 09:58:31 CEST 2024
import simula.runtime.*;
@SuppressWarnings("unchecked")
public class CHECKER1 extends BUILDER2 {
    // ClassDeclaration: Kind=8, BlockLevel=1, PrefixLevel=8, firstLine=3, lastLine=2636, hasLocalClasses=true, System=false, detachUsed=false
    ...
    // Normal Constructor
    public CHECKER1(RTS_RTObject staticLink) {
        super(staticLink);
    ...
    // Class Statements
    @Override
    public CHECKER1 _STM() {
        CHECKER1 _THIS=(CHECKER1)_CUR;
        _LOOP:while(_JTX>=0) {
            try {
