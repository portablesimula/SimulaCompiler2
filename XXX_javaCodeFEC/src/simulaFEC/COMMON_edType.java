...
public final class COMMON_edType extends RTS_PROCEDURE {
...
public Object _RESULT() { return(_RESULT); }
    ...
    @Override
    public COMMON_edType setPar(Object param) {
        try {
            switch(_nParLeft--) {
    ...
    public COMMON_edType(RTS_RTObject _SL) {
        super(_SL,1); // Expecting 1 parameters
    }
    // Normal Constructor
    public COMMON_edType(RTS_RTObject _SL,char sp_t) {
        super(_SL);
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("COMMON.sim","5 edType",1,128,42,129,46,130,50,131,54,132,58,133,62,134,66,135,70,136,74,137,78,138,82,139,86,140,90,141,94,142,98,143,117,144);
} // End of Procedure
