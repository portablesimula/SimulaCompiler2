...
public final class ERRMSG_internerr extends RTS_PROCEDURE {
    ...
    @Override
    public ERRMSG_internerr setPar(Object param) {
        try {
            switch(_nParLeft--) {
    ...
    public ERRMSG_internerr(RTS_RTObject _SL) {
        super(_SL,2); // Expecting 2 parameters
    }
    // Normal Constructor
    public ERRMSG_internerr(RTS_RTObject _SL,char sp_module,int sp_lnr) {
        super(_SL);
    ...
    @Override
    public ERRMSG_internerr _STM() {
        if(_VALUE((((ERRMSG)(_CUR._SL)).numerrfound==(0)))) {
            {
                // BEGIN INSPECTION 
                _inspect_322_4462=RTS_BASICIO.sysout();
                if(_inspect_322_4462!=null) { // INSPECT _inspect_322_4462
                    // JavaLine 51 <== SourceLine 323
                    {
                        // JavaLine 53 <== SourceLine 322
                        {
                            ...
                            ;
                            _inspect_322_4462.outint(((ERRMSG)(_CUR._SL)).linenr,0);
                            ;
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("ERRMSG.sim","5 internerr",1,319,12,321,14,322,51,323,53,322,55,323,58,324,62,325,66,326,70,327,74,328,78,329,82,330,86,331,90,332,94,333,98,334,102,335,106,336,110,337,114,338,118,339,122,340,126,341,130,342,134,343,139,345,142,346,147,347,152,348,161,350,166,351);
} // End of Procedure
