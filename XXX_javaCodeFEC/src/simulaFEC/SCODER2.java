...
public class SCODER2 extends SCODER1E {
    // ClassDeclaration: Kind=8, BlockLevel=1, PrefixLevel=13, firstLine=3, lastLine=1251, hasLocalClasses=true, System=false, detachUsed=false
    ...
    // Normal Constructor
    public SCODER2(RTS_RTObject staticLink) {
        super(staticLink);
