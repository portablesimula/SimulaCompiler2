...
public final class BUILDER2_prechecker_allocate_alloc2_setprefqual extends RTS_PROCEDURE {
...
public Object _RESULT() { return(_RESULT); }
    ...
    final RTS_LABEL _LABEL_BUILDER2_prechecker_allocate_alloc2_setprefqual_out_0=new RTS_LABEL(this,0,1,"out"); // Local Label #1=out At PrefixLevel 0
    ...
    @Override
    public BUILDER2_prechecker_allocate_alloc2_setprefqual setPar(Object param) {
        try {
            switch(_nParLeft--) {
    ...
    public BUILDER2_prechecker_allocate_alloc2_setprefqual(RTS_RTObject _SL) {
        super(_SL,2); // Expecting 2 parameters
    }
    // Normal Constructor
    public BUILDER2_prechecker_allocate_alloc2_setprefqual(RTS_RTObject _SL,COMMON_quantity sp_Q,boolean sp_param) {
        super(_SL);
    ...
    @Override
    public BUILDER2_prechecker_allocate_alloc2_setprefqual _STM() {
        BUILDER2_prechecker_allocate_alloc2_setprefqual _THIS=(BUILDER2_prechecker_allocate_alloc2_setprefqual)_CUR;
        _LOOP:while(_JTX>=0) {
            try {
                ...
                while((p_Q!=(null))) {
                    {
                        ...
                        if(_VALUE(p_param)) {
                            {
                                ...
                                if(_VALUE((p_Q.categ_1==(((char)3))))) {
                                    _GOTO(_LABEL_BUILDER2_prechecker_allocate_alloc2_setprefqual_out_0); // GOTO EVALUATED LABEL
                                }
                                ;
                        ...
                        if(_VALUE((p_Q.type_1==(((char)7))))) {
                            // JavaLine 78 <== SourceLine 1393
                            {
                                ...
                                QX=new BUILDER1_meaningof((_CUR._SL._SL._SL._SL),symx)._RESULT;
                                ;
                                // JavaLine 103 <== SourceLine 1399
                                if(_VALUE((QX==(null)))) {
                                    QX=new ERRMSG_newnotseen((_CUR._SL._SL._SL._SL),symx)._RESULT;
                                }
                                ;
                                ...
                                if(_VALUE((QX.categ_1==(((char)5))))) {
                                    {
                                        ...
                                        if(_VALUE(_IS(p_Q,COMMON_quantity.class))) {
                                            {
                                                // JavaLine 114 <== SourceLine 1403
                                                new ERRMSG_errQTN((_CUR._SL._SL._SL._SL),p_Q,412,QX);
                                                ;
                                                p_Q.type_1=((char)15);
                                            }
                                        } else {
                                    ...
                                    if(_VALUE((QX.kind_1!=(((char)5))))) {
                                        {
                                            ...
                                            if(_VALUE((QX.kind_1==(((char)7))))) {
                                                ...
                                                {
                                                    new ERRMSG_errQTN((_CUR._SL._SL._SL._SL),p_Q,413,QX);
                                                    ;
                                                    p_Q.type_1=((char)15);
                                                }
                                            }
                                ...
                                if(_VALUE((p_Q.prefqual_1==(null)))) {
                                    {
                                        ...
                                        if(_VALUE(((p_Q.ftag_1<(0))|((p_Q.line_1<(0)))))) {
                                            new BUILDER2_prechecker_allocate_alloc2_setprefix((_CUR._SL),p_Q);
                                        }
                                        ;
                                    }
                                }
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("BUILDER2.sim","5 setprefqual",1,1383,14,1423,17,1385,20,1386,22,1383,58,1388,61,1389,64,1390,69,1391,76,1392,78,1393,80,1394,82,1395,89,1396,97,1397,100,1398,103,1399,108,1400,111,1402,114,1403,120,1404,126,1405,131,1407,134,1408,137,1409,143,1410,152,1412,157,1413,163,1416,165,1417,167,1418,170,1419,180,1421,186,1423,201,1424);
} // End of Procedure
