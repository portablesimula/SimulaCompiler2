...
public class CHECKER1_semchecker1_integerdivide extends CHECKER1_semchecker1_arithop {
    ...
    // Normal Constructor
    public CHECKER1_semchecker1_integerdivide(RTS_RTObject staticLink,CHECKER1_semchecker1_exp sp_pred,char sp_ch,CHECKER1_semchecker1_exp sp1_left,CHECKER1_semchecker1_exp sp1_right) {
    ...
    // Class Statements
    @Override
    public CHECKER1_semchecker1_integerdivide _STM() {
        CHECKER1_semchecker1_integerdivide _THIS=(CHECKER1_semchecker1_integerdivide)_CUR;
        _LOOP:while(_JTX>=0) {
            try {
                ...
                if(_VALUE((((CHECKER1)(_CUR._SL._SL)).ltype>=(((char)5))))) {
                    new CHECKER1_semchecker1_exp_typeError(p1_left,302);
                }
                ;
                // JavaLine 146 <== SourceLine 482
                if(_VALUE((((CHECKER1)(_CUR._SL._SL)).rtype>=(((char)5))))) {
                    new CHECKER1_semchecker1_exp_typeError(p1_right,303);
                }
                ;
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("CHECKER1.sim","8 integerdivide",1,477,10,461,26,169,28,223,30,443,34,444,40,445,43,446,49,448,52,449,55,450,68,452,71,453,74,454,79,456,84,457,86,459,95,461,107,465,113,466,115,467,125,469,127,470,130,471,139,474,141,481,146,482,151,483,154,484,169,484);
} // End of Class
