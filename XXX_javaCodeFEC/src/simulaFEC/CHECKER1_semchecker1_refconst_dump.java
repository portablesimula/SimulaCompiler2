...
public final class CHECKER1_semchecker1_refconst_dump extends RTS_PROCEDURE {
    ...
    // Normal Constructor
    public CHECKER1_semchecker1_refconst_dump(RTS_RTObject _SL) {
        super(_SL);
    ...
    @Override
    public CHECKER1_semchecker1_refconst_dump _STM() {
        // JavaLine 23 <== SourceLine 1239
        {
            // BEGIN INSPECTION 
            _inspect_1239_4572=RTS_BASICIO.sysout();
            if(_inspect_1239_4572!=null) { // INSPECT _inspect_1239_4572
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("CHECKER1.sim","5 dump",1,1239,10,1240,23,1239,28,1240,40,1240);
} // End of Procedure
