...
public class COMMON_brecord extends RTS_CLASS {
    ...
    public COMMON_quantity declquant=null;
    // JavaLine 41 <== SourceLine 411
    public COMMON_quantity fpar=null;
    // JavaLine 43 <== SourceLine 412
    public COMMON_quantity favirt=null;
    // JavaLine 45 <== SourceLine 413
    public COMMON_idpack hidlist=null;
    // JavaLine 47 <== SourceLine 416
    public COMMON_stackedb preinsp=null;
    // Normal Constructor
    public COMMON_brecord(RTS_RTObject staticLink) {
        super(staticLink);
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("COMMON.sim","8 brecord",1,393,10,395,15,396,19,397,21,399,23,400,25,401,27,402,29,403,31,404,33,406,35,408,37,409,39,410,41,411,43,412,45,413,47,416,59,556,64,556);
} // End of Class
