...
public class CHECKER1_semchecker1_valuerel extends CHECKER1_semchecker1_relation {
...
public boolean isDetachUsed() { return(true); }
    ...
    final RTS_LABEL _LABEL_CHECKER1_semchecker1_valuerel_Block375_Block407_TypErr_0=new RTS_LABEL(this,3,1,"TypErr"); // Local Label #1=TypErr At PrefixLevel 3
    // Declare locals as attributes
    public RTS_PRCQNT emit_0() { return(new RTS_PRCQNT(this,CHECKER1_semchecker1_valuerel_emit.class)); }
    // Normal Constructor
    public CHECKER1_semchecker1_valuerel(RTS_RTObject staticLink,CHECKER1_semchecker1_exp sp_pred,char sp_ch,CHECKER1_semchecker1_exp sp1_left,CHECKER1_semchecker1_exp sp1_right) {
    ...
    // Class Statements
    @Override
    public CHECKER1_semchecker1_valuerel _STM() {
        CHECKER1_semchecker1_valuerel _THIS=(CHECKER1_semchecker1_valuerel)_CUR;
        _LOOP:while(_JTX>=0) {
            try {
                ...
                while(true) {
                    {
                        ...
                        ((CHECKER1_semchecker1)(_CUR._SL)).exptop_2=((CHECKER1_semchecker1_valuerel)(_CUR));
                        ;
                        ...
                        switch(opttype_2) { // BEGIN SWITCH STATEMENT
                            ...
                            if(_VALUE((p_ch==(((char)17))))) {
                                ...
                                _GOTO(_LABEL_CHECKER1_semchecker1_valuerel_Block375_Block407_TypErr_0); // GOTO EVALUATED LABEL
                            }
                            break;
                            case 2: 
                            case 3: 
                            ...
                            switch(p1_right.type) { // BEGIN SWITCH STATEMENT
                                ...
                                // JavaLine 83 <== SourceLine 388
                                {
                                    ...
                                    ((CHECKER1)(_CUR._SL._SL)).rtype=p1_right.type;
                                    ;
                                    // JavaLine 88 <== SourceLine 392
                                    if(_VALUE((((opttype_2<=(((char)4)))&&((((CHECKER1)(_CUR._SL._SL)).rtype==(((char)2)))))||(((opttype_2==(((char)2)))&&(((((CHECKER1)(_CUR._SL._SL)).rtype==(((char)4)))|((((CHECKER1)(_CUR._SL._SL)).rtype==(((char)3))))))))))) {
                            ...
                            // JavaLine 122 <== SourceLine 406
                            {
                                ...
                                {
                                    _SIM_LABEL(1); // DeclaredIn: valuerel -> valuerel[CHECKER1_semchecker1_valuerel] DeclarationKind=Class
                        ...
                        ((CHECKER1_semchecker1)(_CUR._SL)).valrelList_2=null;
                        ;
                        // JavaLine 144 <== SourceLine 416
                        p1_right=((CHECKER1_semchecker1)(_CUR._SL)).exptop_2;
                        ;
