...
public class PAS2INIT extends SCODER4 {
    // ClassDeclaration: Kind=8, BlockLevel=1, PrefixLevel=16, firstLine=3, lastLine=646, hasLocalClasses=true, System=false, detachUsed=false
    ...
    // Normal Constructor
    public PAS2INIT(RTS_RTObject staticLink) {
        super(staticLink);
    ...
    // Class Statements
    @Override
    public PAS2INIT _STM() {
        PAS2INIT _THIS=(PAS2INIT)_CUR;
        _LOOP:while(_JTX>=0) {
            try {
                _JUMPTABLE(_JTX,1); // For ByteCode Engineering
                // JavaLine 26 <== SourceLine 1322
                // BEGIN INNER PART
               ...
               ,new FOR_SingleElt<RTS_TXT>(new RTS_NAME<RTS_TXT>(){ public RTS_TXT put(RTS_TXT x_){simsymbol=x_; return(x_);};  public RTS_TXT get(){return((RTS_TXT)simsymbol); }	},new RTS_NAME<RTS_TXT>() { public RTS_TXT get(){return(new RTS_TXT("library")); }})
                ...
                // BEGIN INNER PART
                // JavaLine 1195 <== SourceLine 494
                // BEGIN INNER PART
                // JavaLine 1197 <== SourceLine 646
                // BEGIN INNER PART
                // ENDOF INNER PART
                // ENDOF INNER PART
                // ENDOF INNER PART
