...
public class CHECKER2 extends CHECKER1 {
    // ClassDeclaration: Kind=8, BlockLevel=1, PrefixLevel=9, firstLine=3, lastLine=1664, hasLocalClasses=true, System=false, detachUsed=false
    ...
    // Normal Constructor
    public CHECKER2(RTS_RTObject staticLink) {
        super(staticLink);
    ...
    // Class Statements
    @Override
    public CHECKER2 _STM() {
        CHECKER2 _THIS=(CHECKER2)_CUR;
        _LOOP:while(_JTX>=0) {
            try {
