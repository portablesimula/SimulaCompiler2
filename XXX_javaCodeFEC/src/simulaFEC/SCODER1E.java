...
public class SCODER1E extends SCODER1 {
    // ClassDeclaration: Kind=8, BlockLevel=1, PrefixLevel=12, firstLine=3, lastLine=371, hasLocalClasses=true, System=false, detachUsed=false
    ...
    // Normal Constructor
    public SCODER1E(RTS_RTObject staticLink) {
        super(staticLink);
    ...
    // Class Statements
    @Override
    public SCODER1E _STM() {
        SCODER1E _THIS=(SCODER1E)_CUR;
        _LOOP:while(_JTX>=0) {
            try {
