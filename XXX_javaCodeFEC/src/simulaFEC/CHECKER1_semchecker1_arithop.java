...
public class CHECKER1_semchecker1_arithop extends CHECKER1_semchecker1_operation {
    ...
    public RTS_PRCQNT emit_0() { return(new RTS_PRCQNT(this,CHECKER1_semchecker1_arithop_emit.class)); }
    // Normal Constructor
    public CHECKER1_semchecker1_arithop(RTS_RTObject staticLink,CHECKER1_semchecker1_exp sp_pred,char sp_ch,CHECKER1_semchecker1_exp sp1_left,CHECKER1_semchecker1_exp sp1_right) {
    ...
    // Class Statements
    @Override
    public CHECKER1_semchecker1_arithop _STM() {
        CHECKER1_semchecker1_arithop _THIS=(CHECKER1_semchecker1_arithop)_CUR;
        _LOOP:while(_JTX>=0) {
            try {
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("CHECKER1.sim","8 arithop",1,421,10,461,27,169,29,223,31,443,35,444,41,445,44,446,50,448,53,449,56,450,69,452,72,453,75,454,80,456,85,457,87,459,96,461,108,465,114,466,116,467,126,469,128,470,131,471,140,474,154,474);
} // End of Class
