...
public class SCODER3 extends SCODER2 {
    // ClassDeclaration: Kind=8, BlockLevel=1, PrefixLevel=14, firstLine=3, lastLine=1444, hasLocalClasses=true, System=false, detachUsed=false
    ...
    // Normal Constructor
    public SCODER3(RTS_RTObject staticLink) {
        super(staticLink);
