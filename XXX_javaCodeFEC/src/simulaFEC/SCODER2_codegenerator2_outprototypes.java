...
public final class SCODER2_codegenerator2_outprototypes extends RTS_PROCEDURE {
    ...
    public COMMON_quantity pqty=null;
    // JavaLine 14 <== SourceLine 208
    public COMMON_brecord lastC=null;
    // JavaLine 16 <== SourceLine 229
    public COMMON_brecord _inspect_229_4640=null;
    // JavaLine 18 <== SourceLine 246
    public COMMON_quantity _inspect_246_4641=null;
    // JavaLine 20 <== SourceLine 248
    public COMMON_quantity _inspect_248_4642=null;
    // Parameter Transmission in case of Formal/Virtual Procedure Call
    @Override
    public SCODER2_codegenerator2_outprototypes setPar(Object param) {
        try {
            switch(_nParLeft--) {
    ...
    public SCODER2_codegenerator2_outprototypes(RTS_RTObject _SL) {
        super(_SL,1); // Expecting 1 parameters
    }
    // Normal Constructor
    public SCODER2_codegenerator2_outprototypes(RTS_RTObject _SL,COMMON_quantity sp_q) {
        super(_SL);
    ...
    @Override
    public SCODER2_codegenerator2_outprototypes _STM() {
        ...
        while((qty!=(null))) {
            {
                ...
                if(_VALUE((qty.special_1==(((char)2))))) {
                    // JavaLine 58 <== SourceLine 224
                    {
                        ...
                        if(_VALUE((pqty==(null)))) {
                            p_q.descr_1.fpar=((COMMON_quantity)(qty.next));
                        } else {
                        ...
                        // JavaLine 68 <== SourceLine 229
                        {
                            ...
                            if(_inspect_229_4640!=null) { // INSPECT _inspect_229_4640
                                // JavaLine 73 <== SourceLine 230
                                {
                                    // JavaLine 75 <== SourceLine 229
                                    {
                                        ...
                                        lastC=((COMMON_brecord)_inspect_229_4640);
                                        ;
                                    }
                                }
                            }
                        ...
                        if(_VALUE((qty.categ_1==(((char)3))))) {
                            {
                                ...
                                if(_VALUE((qty.kind_1==(((char)5))))) {
                                    new SCODER2_codegenerator2_outprototypes((_CUR._SL),qty);
                                }
                            }
                        }
                        ;
        ...
        new SCODER2_codegenerator2_prototypegenerator((_CUR._SL),p_q);
        ;
        ...
        while((lastC!=(null))) {
            {
                // JavaLine 123 <== SourceLine 246
                {
                    ...
                    if(_inspect_246_4641!=null) { // INSPECT _inspect_246_4641
                        {
                ...
                // JavaLine 138 <== SourceLine 248
                {
                    ...
                    if(_inspect_248_4642!=null) { // INSPECT _inspect_248_4642
                        {
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("SCODER2.sim","5 outprototypes",1,203,11,207,14,208,16,229,18,246,20,248,50,209,53,210,56,223,58,224,60,226,64,227,68,229,73,230,75,229,77,230,80,231,83,233,93,236,95,237,98,238,105,239,111,241,117,243,120,245,123,246,133,247,138,248,148,249,158,251);
} // End of Procedure
