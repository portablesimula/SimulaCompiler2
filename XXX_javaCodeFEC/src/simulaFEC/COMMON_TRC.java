...
public final class COMMON_TRC extends RTS_PROCEDURE {
    ...
    @Override
    public COMMON_TRC setPar(Object param) {
        try {
            switch(_nParLeft--) {
    ...
    public COMMON_TRC(RTS_RTObject _SL) {
        super(_SL,3); // Expecting 3 parameters
    }
    // Normal Constructor
    public COMMON_TRC(RTS_RTObject _SL,RTS_TXT sp_m1,int sp_line,RTS_TXT sp_m2) {
        super(_SL);
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("COMMON.sim","5 TRC",1,49,45,51,48,52,51,53,56,55);
} // End of Procedure
