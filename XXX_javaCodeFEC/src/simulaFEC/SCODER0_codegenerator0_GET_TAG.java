...
public final class SCODER0_codegenerator0_GET_TAG extends RTS_PROCEDURE {
...
public Object _RESULT() { return(_RESULT); }
    ...
    @Override
    public SCODER0_codegenerator0_GET_TAG setPar(Object param) {
        try {
            switch(_nParLeft--) {
    ...
    public SCODER0_codegenerator0_GET_TAG(RTS_RTObject _SL) {
        super(_SL,1); // Expecting 1 parameters
    }
    // Normal Constructor
    public SCODER0_codegenerator0_GET_TAG(RTS_RTObject _SL,RTS_TXT sp_m) {
        super(_SL);
    ...
    @Override
    public SCODER0_codegenerator0_GET_TAG _STM() {
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("SCODER0.sim","5 GET_TAG",1,261,13,262,17,261,47,263,50,264,55,265,60,266);
} // End of Procedure
