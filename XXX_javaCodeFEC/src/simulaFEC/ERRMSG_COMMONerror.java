...
public final class ERRMSG_COMMONerror extends RTS_PROCEDURE {
    ...
    @Override
    public ERRMSG_COMMONerror setPar(Object param) {
        try {
            switch(_nParLeft--) {
    ...
    public ERRMSG_COMMONerror(RTS_RTObject _SL) {
        super(_SL,1); // Expecting 1 parameters
    }
    // Normal Constructor
    public ERRMSG_COMMONerror(RTS_RTObject _SL,int sp_EXC_NUMBER) {
        super(_SL);
    ...
    @Override
    public ERRMSG_COMMONerror _STM() {
        // JavaLine 39 <== SourceLine 211
        if(_VALUE((p_EXC_NUMBER>(0)))) {
            new ERRMSG_fatal0((_CUR._SL),p_EXC_NUMBER);
        } else {
                    ...
                    // JavaLine 55 <== SourceLine 217
                    {
                        ...
                        if(_VALUE((p_EXC_NUMBER==(11)))) {
                            ...
                            // JavaLine 65 <== SourceLine 221
                            {
                                ...
                                if(_VALUE((((ERRMSG)(_CUR._SL)).numerrfound==(0)))) {
                                    {
                                ...
                                if(_VALUE((((ERRMSG)(_CUR._SL)).linenr>(0)))) {
                                    {
                                        // JavaLine 87 <== SourceLine 228
                                        RTS_BASICIO.sysout().outtext(new RTS_TXT(" at source line "));
                                        ;
                                        RTS_BASICIO.sysout().outint(((ERRMSG)(_CUR._SL)).linenr,0);
                                        ;
                                    }
                                }
                                ;
                                // JavaLine 95 <== SourceLine 230
                                RTS_BASICIO.sysout().outtext((((((ERRMSG)(_CUR._SL)).currentpass==('1')))?(new RTS_TXT(" (Pass1) ***")):(new RTS_TXT(" (Pass2) ***"))));
                                ;
                            }
                        }
                        ;
                        // JavaLine 101 <== SourceLine 233
                        if(_VALUE(((((ERRMSG)(_CUR._SL)).listfile!=(null))&&((((ERRMSG)(_CUR._SL)).listfile!=(RTS_BASICIO.sysout())))))) {
                            {
                                // JavaLine 104 <== SourceLine 234
                                ((ERRMSG)(_CUR._SL)).listfile.outtext(RTS_TXT.strip(RTS_BASICIO.sysout().image));
                                ;
                                ((ERRMSG)(_CUR._SL)).listfile.outimage();
                                ;
                            }
                        }
                        ;
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("ERRMSG.sim","5 COMMONerror",1,209,39,211,43,212,47,213,50,215,55,217,57,218,60,219,65,221,67,222,70,223,73,224,80,226,84,227,87,228,95,230,101,233,104,234,115,237,118,238,121,239,128,240);
} // End of Procedure
