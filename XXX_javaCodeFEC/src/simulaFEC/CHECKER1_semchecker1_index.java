...
public class CHECKER1_semchecker1_index extends CHECKER1_semchecker1_argument {
    ...
    public RTS_PRCQNT dump_0() { return(new RTS_PRCQNT(this,CHECKER1_semchecker1_index_dump.class)); }
    public RTS_PRCQNT emit_0() { return(new RTS_PRCQNT(this,CHECKER1_semchecker1_index_emit.class)); }
    // Normal Constructor
    public CHECKER1_semchecker1_index(RTS_RTObject staticLink,int sp_argno,CHECKER1_semchecker1_exp sp_actual) {
    ...
    // Class Statements
    @Override
    public CHECKER1_semchecker1_index _STM() {
        ...
        if(_VALUE((p_actual==(null)))) {
            ...
            // JavaLine 27 <== SourceLine 2153
            {
                ...
                switch(p_actual.type) { // BEGIN SWITCH STATEMENT
                    ...
                    new CHECKER1_semchecker1_argument_errARG((_CUR),419);
                    break;
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("CHECKER1.sim","8 index",1,2133,21,2130,23,2152,27,2153,29,2155,37,2158,42,2161,44,2162,51,2164,57,2164);
} // End of Class
