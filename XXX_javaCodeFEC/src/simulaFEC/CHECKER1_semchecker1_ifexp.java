...
public class CHECKER1_semchecker1_ifexp extends CHECKER1_semchecker1_operation {
    ...
    public CHECKER1_semchecker1_exp p2_testexp;
    // Declare local labels
    // JavaLine 11 <== SourceLine 1137
    final RTS_LABEL _LABEL_CHECKER1_semchecker1_ifexp_NONCOMP_2=new RTS_LABEL(this,2,1,"NONCOMP"); // Local Label #1=NONCOMP At PrefixLevel 2
    // Declare locals as attributes
    public RTS_PRCQNT dump_0() { return(new RTS_PRCQNT(this,CHECKER1_semchecker1_ifexp_dump.class)); }
    public RTS_PRCQNT emit_0() { return(new RTS_PRCQNT(this,CHECKER1_semchecker1_ifexp_emit.class)); }
    // Normal Constructor
    public CHECKER1_semchecker1_ifexp(RTS_RTObject staticLink,CHECKER1_semchecker1_exp sp_pred,char sp_ch,CHECKER1_semchecker1_exp sp1_left,CHECKER1_semchecker1_exp sp1_right,CHECKER1_semchecker1_exp sp2_testexp) {
    ...
    // Class Statements
    @Override
    public CHECKER1_semchecker1_ifexp _STM() {
        CHECKER1_semchecker1_ifexp _THIS=(CHECKER1_semchecker1_ifexp)_CUR;
        _LOOP:while(_JTX>=0) {
            try {
                ...
                if(_VALUE((p2_testexp.type!=(((char)1))))) {
                    {
                        if(_VALUE((p2_testexp.type!=(((char)15))))) {
                            ...
                            new ERRMSG_error0((_CUR._SL._SL),161);
                        }
                    }
                }
                ;
                ...
                if(_VALUE((p2_testexp.ctype==('Z')))) {
                    ...
                    new CHECKER1_semchecker1_checkasexp((_CUR._SL),((CHECKER1_semchecker1_identifier)(p2_testexp)));
                }
                ;
                    ...
                    switch(p1_right.type) { // BEGIN SWITCH STATEMENT
                        ...
                        if(_VALUE((type!=(p1_right.type)))) {
                            // JavaLine 96 <== SourceLine 1137
                            {
                                ...
                                new CHECKER1_semchecker1_exp_incompTypes((_CUR),type,p1_right.type);
                            }
                        }
                        break;
                        default:
                        // JavaLine 104 <== SourceLine 1138
                        _GOTO(_LABEL_CHECKER1_semchecker1_ifexp_NONCOMP_2); // GOTO EVALUATED LABEL
                        break;
                            ...
                            if(_VALUE((qual!=(p1_right.qual)))) {
                                {
                                    ...
                                    if(_VALUE((qual==(null)))) {
                                        ...
                                        if(_VALUE((p1_right.qual!=(null)))) {
                                            new CHECKER1_semchecker1_ifexp_Block1142_Block1143_Block1145((_CUR))._STM();
                                        }
                                    }
                                    ;
                                }
