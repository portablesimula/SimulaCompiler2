...
public final class SCODER1_codegenerator1_getTypeTag extends RTS_PROCEDURE {
...
public Object _RESULT() { return(_RESULT); }
    ...
    @Override
    public SCODER1_codegenerator1_getTypeTag setPar(Object param) {
        try {
            switch(_nParLeft--) {
    ...
    public SCODER1_codegenerator1_getTypeTag(RTS_RTObject _SL) {
        super(_SL,1); // Expecting 1 parameters
    }
    // Normal Constructor
    public SCODER1_codegenerator1_getTypeTag(RTS_RTObject _SL,COMMON_quantity sp_qty) {
        super(_SL);
    ...
    @Override
    public SCODER1_codegenerator1_getTypeTag _STM() {
        ...
        if(_VALUE((p_qty.categ_1==(((char)2))))) {
            ...
            if(_VALUE((p_qty.kind_1==(((char)2))))) {
                ...
                if(_VALUE(((p_qty.kind_1==(((char)0)))||((p_qty.kind_1==(((char)6))))))) {
                    ...
                    _RESULT=(((p_qty.special_1==(((char)0))))?(((SCODER1_codegenerator1)(_CUR._SL)).typetag.getELEMENT(RTS_ENVIRONMENT.rank(p_qty.type_1))):(0));
                } else {
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("SCODER1.sim","5 getTypeTag",1,230,42,232,46,233,50,235,52,239,55,241,57,242,60,247,63,248,67,249,71,250,75,251,82,253,92,254);
} // End of Procedure
