...
public final class SCODER2_codegenerator2_profilegenerator extends RTS_PROCEDURE {
    // ProcedureDeclaration: Kind=5, BlockLevel=3, firstLine=37, lastLine=124, hasLocalClasses=false, System=false
    // Declare parameters as attributes
    public COMMON_extquantity p_extq;
    ...
    public COMMON_symbolbox _inspect_86_4639=null;
    // Parameter Transmission in case of Formal/Virtual Procedure Call
    @Override
    public SCODER2_codegenerator2_profilegenerator setPar(Object param) {
        try {
            switch(_nParLeft--) {
                case 1: p_extq=(COMMON_extquantity)objectValue(param); break;
    ...
    public SCODER2_codegenerator2_profilegenerator(RTS_RTObject _SL) {
        super(_SL,1); // Expecting 1 parameters
    }
    // Normal Constructor
    public SCODER2_codegenerator2_profilegenerator(RTS_RTObject _SL,COMMON_extquantity sp_extq) {
        super(_SL);
    ...
    @Override
    public SCODER2_codegenerator2_profilegenerator _STM() {
        ...
        if(_VALUE((p_extq.p2_module==(null)))) {
            {
                ...
                ((SCODER2_codegenerator2)(_CUR._SL)).outbyte(30);
                ;
                // JavaLine 65 <== SourceLine 61
                new SCODER0_codegenerator0_outtag((_CUR._SL),(p_extq.ftag_1+(0)));
                ;
                // JavaLine 68 <== SourceLine 62
                ((SCODER2_codegenerator2)(_CUR._SL)).outtext(CONC(new RTS_TXT("!"),new RTS_TXT("\u0000\u0000")));
                ;
                // JavaLine 71 <== SourceLine 63
                new SCODER0_codegenerator0_outtag((_CUR._SL),(p_extq.ftag_1+(1)));
                ;
                // JavaLine 74 <== SourceLine 64
                it=p_extq.symb_1.symbol;
                ;
                // JavaLine 77 <== SourceLine 65
                ((SCODER2_codegenerator2)(_CUR._SL)).outbyte(RTS_TXT.length(it));
                ;
                ((SCODER2_codegenerator2)(_CUR._SL)).outtext(it);
                ;
                // JavaLine 82 <== SourceLine 66
                it=new COMMON_getBox((_CUR._SL._SL),language)._RESULT.symbol;
                ;
                ...
                it=new COMMON_getBox((_CUR._SL._SL),p_extq.virtno_1)._RESULT.symbol;
                ;
                ...
                if(_VALUE((language>(RTS_ENVIRONMENT.rank('N'))))) {
                    // JavaLine 100 <== SourceLine 71
                    {
                        ...
                        new SCODER0_codegenerator0_outtag((_CUR._SL),(p_extq.ftag_1+(2)));
                        ;
                ...
                if(_VALUE((language==(RTS_ENVIRONMENT.rank('L'))))) {
                    new SCODER2_codegenerator2_profilegenerator_invert((_CUR));
                }
                ;
                ...
                while((qty!=(null))) {
                    {
                        // JavaLine 142 <== SourceLine 86
                        {
                            ...
                            if(_inspect_86_4639!=null) { // INSPECT _inspect_86_4639
                                // JavaLine 147 <== SourceLine 87
                                {
                                    // JavaLine 149 <== SourceLine 86
                                    {
                                        ...
                                        ((SCODER2_codegenerator2)(_CUR._SL)).outtext(CONC(new RTS_TXT("\""),new RTS_TXT("\u0000\u0000")));
                                        ;
                                        new SCODER0_codegenerator0_outtag((_CUR._SL),qty.ftag_1);
                                        ;
                                        ...
                                        new SCODER0_codegenerator0_outTagWithIdent((_CUR._SL),(((qty.kind_1==(((char)1))))?(11):((((qty.categ_1==(((char)2))))?(9):(((((CP&&((qty.categ_1==(((char)1)))))&&((((qty.type_1==(((char)8)))||((qty.type_1==(((char)7)))))||((qty.kind_1==(((char)2))))))))?(8):((((((qty.type_1==(((char)7)))|((qty.type_1==(((char)9)))))|((qty.kind_1==(((char)2))))))?(8):((((qty.kind_1==(((char)3))))?(10):(((SCODER2_codegenerator2)(_CUR._SL)).typetag.getELEMENT(RTS_ENVIRONMENT.rank(qty.type_1)))))))))))));
                                        ;
                                    }
                                }
                            }
                ...
                if(_VALUE((p_extq.type_1!=(((char)14))))) {
                    {
                        ...
                        ((SCODER2_codegenerator2)(_CUR._SL)).outbyte(35);
                        ;
                        new SCODER0_codegenerator0_outtag((_CUR._SL),(p_extq.ftag_1+(3)));
                        ;
                        // JavaLine 216 <== SourceLine 118
                        new SCODER0_codegenerator0_outTagWithIdent((_CUR._SL),(((CP&&((p_extq.type_1==(((char)8))))))?(8):(((SCODER2_codegenerator2)(_CUR._SL)).typetag.getELEMENT(RTS_ENVIRONMENT.rank(p_extq.type_1)))));
                        ;
                    }
                }
                ;
                // JavaLine 222 <== SourceLine 122
                ((SCODER2_codegenerator2)(_CUR._SL)).outbyte(37);
                ;
            }
        }
        ;
