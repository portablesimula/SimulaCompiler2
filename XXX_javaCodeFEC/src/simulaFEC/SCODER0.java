...
public class SCODER0 extends CHECKER2 {
    ...
    // JavaLine 13 <== SourceLine 17
    public final int k_smp_10=(int)(0);
    public final int k_pro_10=(int)(1);
    public final int k_arr_10=(int)(2);
    // JavaLine 17 <== SourceLine 18
    public final int k_lab_10=(int)(3);
    public final int k_swt_10=(int)(4);
    public final int k_cla_10=(int)(5);
    // JavaLine 21 <== SourceLine 25
    public final int m_ref_10=(int)(0);
    public final int m_value_10=(int)(1);
    public final int m_name_10=(int)(2);
    // JavaLine 25 <== SourceLine 26
    public final int m_local_10=(int)(3);
    public final int m_lit_10=(int)(5);
    // JavaLine 28 <== SourceLine 31
    public final int t_notype_10=(int)(0);
    // JavaLine 30 <== SourceLine 32
    public final int t_boo_10=(int)(1);
    public final int t_cha_10=(int)(2);
    public final int t_sin_10=(int)(3);
    public final int t_int_10=(int)(4);
    // JavaLine 35 <== SourceLine 33
    public final int t_rea_10=(int)(5);
    public final int t_lrl_10=(int)(6);
    public final int t_ref_10=(int)(7);
    public final int t_txt_10=(int)(8);
    // JavaLine 40 <== SourceLine 34
    public final int t_ptr_10=(int)(9);
    // JavaLine 42 <== SourceLine 39
    public final int s_txtent_10=(int)(12);
    // JavaLine 44 <== SourceLine 44
    public final int par_qnt_lit_10=(int)(0);
    public final int par_qnt_nas_10=(int)(1);
    public final int par_qnt_ass_10=(int)(2);
    // JavaLine 48 <== SourceLine 45
    public final int par_thk_nas_10=(int)(3);
    public final int par_thk_ass_10=(int)(4);
    // JavaLine 51 <== SourceLine 55
    public final int quantdisp_10=(int)(0);
    // JavaLine 53 <== SourceLine 56
    public final int descriptordisp_10=(int)(0);
    // JavaLine 55 <== SourceLine 57
    public final int prototypedisp_10=(int)(1);
    // JavaLine 57 <== SourceLine 58
    public final int cntdisp_10=(int)(2);
    // JavaLine 59 <== SourceLine 59
    public final int startdisp_10=(int)(2);
    // JavaLine 61 <== SourceLine 60
    public final int dcldisp_10=(int)(2);
    // JavaLine 63 <== SourceLine 61
    public final int stmdisp_10=(int)(3);
    // JavaLine 65 <== SourceLine 62
    public final int cnt_inrdisp_10=(int)(4);
    // JavaLine 67 <== SourceLine 63
    public final int profiledisp_10=(int)(0);
    // JavaLine 69 <== SourceLine 64
    public final int bodydisp_10=(int)(1);
    // JavaLine 71 <== SourceLine 65
    public final int contextdisp_10=(int)(2);
    // JavaLine 73 <== SourceLine 66
    public final int exportdisp_10=(int)(3);
    // JavaLine 75 <== SourceLine 67
    public final int indirectdisp_10=(int)(1);
    // JavaLine 77 <== SourceLine 69
    public final int atrdesdisp_10=(int)(1);
    // JavaLine 79 <== SourceLine 71
    public final int sequdisp_10=(int)(-1);
    // Normal Constructor
    public SCODER0(RTS_RTObject staticLink) {
        super(staticLink);
    ...
    @Override
    public SCODER0 _STM() {
        SCODER0 _THIS=(SCODER0)_CUR;
        _LOOP:while(_JTX>=0) {
            try {
                _JUMPTABLE(_JTX,1); // For ByteCode Engineering
                // JavaLine 94 <== SourceLine 1322
                // BEGIN INNER PART
                // JavaLine 96 <== SourceLine 998
                // BEGIN INNER PART
                // JavaLine 98 <== SourceLine 2395
                // BEGIN INNER PART
                // JavaLine 100 <== SourceLine 89
                // BEGIN INNER PART
                // JavaLine 102 <== SourceLine 2697
                // BEGIN INNER PART
                ...
                ;
                // JavaLine 109 <== SourceLine 37
                recomp=(RTS_ENVIRONMENT.getIntInfo(22)==(1));
                ;
                // JavaLine 112 <== SourceLine 38
               ...
               ,new FOR_SingleElt<RTS_TXT>(new RTS_NAME<RTS_TXT>(){ public RTS_TXT put(RTS_TXT x_){simsymbol=x_; return(x_);};  public RTS_TXT get(){return((RTS_TXT)simsymbol); }	},new RTS_NAME<RTS_TXT>() { public RTS_TXT get(){return(new RTS_TXT("library")); }})
                ...
                ;
                // JavaLine 395 <== SourceLine 122
                i_5=(RTS_ENVIRONMENT.rank(identlo)+(1));
                ;
                // JavaLine 398 <== SourceLine 123
                while((i_5<=(255))) {
                    {
                        // JavaLine 401 <== SourceLine 124
                ...
                ;
                // JavaLine 1051 <== SourceLine 179
                call(parser,179);
                ;
                // JavaLine 1054 <== SourceLine 185
                {
                    // BEGIN INSPECTION 
                    ...
                    if(_inspect_185_4515_5!=null) { // INSPECT _inspect_185_4515_5
                        // JavaLine 1059 <== SourceLine 186
                        {
                            // JavaLine 1061 <== SourceLine 185
                            {
                                // JavaLine 1063 <== SourceLine 186
                    ...
                    if(_inspect_227_4516_5!=null) { // INSPECT _inspect_227_4516_5
                        // JavaLine 1161 <== SourceLine 228
                        {
                            // JavaLine 1163 <== SourceLine 227
                            {
                                ...
                                ;
                                // JavaLine 1232 <== SourceLine 252
                                nextbllo=((char)1);
                                ;
                                // JavaLine 1235 <== SourceLine 253
                ...
                ;
                // JavaLine 1243 <== SourceLine 257
                // BEGIN INNER PART
                // JavaLine 1245 <== SourceLine 797
                // BEGIN INNER PART
                // JavaLine 1247 <== SourceLine 1883
                // BEGIN INNER PART
                // JavaLine 1249 <== SourceLine 2636
                // BEGIN INNER PART
                // JavaLine 1251 <== SourceLine 1664
                // BEGIN INNER PART
                // JavaLine 1253 <== SourceLine 311
                // BEGIN INNER PART
                // ENDOF INNER PART
                // ENDOF INNER PART
                // ENDOF INNER PART
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("S