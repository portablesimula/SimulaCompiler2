...
public final class COMMON_edSymbol extends RTS_PROCEDURE {
...
public Object _RESULT() { return(_RESULT); }
    ...
    public COMMON_symbolbox symbox=null;
    // JavaLine 16 <== SourceLine 32
    public RTS_TXT _RESULT=null;
    // Parameter Transmission in case of Formal/Virtual Procedure Call
    @Override
    public COMMON_edSymbol setPar(Object param) {
        try {
            switch(_nParLeft--) {
    ...
    public COMMON_edSymbol(RTS_RTObject _SL) {
        super(_SL,2); // Expecting 2 parameters
    }
    // Normal Constructor
    public COMMON_edSymbol(RTS_RTObject _SL,char sp_hi,char sp_lo) {
        super(_SL);
    ...
    @Override
    public COMMON_edSymbol _STM() {
        // JavaLine 48 <== SourceLine 34
        symbox=new COMMON_boxof((_CUR._SL),p_hi,p_lo)._RESULT;
        ;
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("COMMON.sim","5 edSymbol",1,32,14,33,16,32,48,34,51,35,56,36);
} // End of Procedure
