...
public final class ERRMSG_GiveMessage extends RTS_PROCEDURE {
    ...
    @Override
    public ERRMSG_GiveMessage setPar(Object param) {
        try {
            switch(_nParLeft--) {
    ...
    public ERRMSG_GiveMessage(RTS_RTObject _SL) {
        super(_SL,2); // Expecting 2 parameters
    }
    // Normal Constructor
    public ERRMSG_GiveMessage(RTS_RTObject _SL,char sp_ec,int sp_index) {
        super(_SL);
    ...
    @Override
    public ERRMSG_GiveMessage _STM() {
        // JavaLine 46 <== SourceLine 58
        if(_VALUE((((ERRMSG)(_CUR._SL)).messageLinenr<=(0)))) {
            ((ERRMSG)(_CUR._SL)).messageLinenr=((ERRMSG)(_CUR._SL)).linenr;
        }
        ;
        ...
        if(_VALUE((((((ERRMSG)(_CUR._SL)).currentpass>('1'))|((p_ec>=(((char)3)))))&&((((ERRMSG)(_CUR._SL)).messageLinenr>(0)))))) {
            // JavaLine 56 <== SourceLine 62
            {
                // JavaLine 58 <== SourceLine 63
                tout=new COMMON_leftint((_CUR._SL),((ERRMSG)(_CUR._SL)).messageLinenr)._RESULT;
                ;
        ...
        ((ERRMSG)(_CUR._SL)).messageLinenr=0;
        ;
        i=(RTS_TXT.length(t)+(1));
        ;
        // JavaLine 71 <== SourceLine 67
        tout=new ERRMSG_diagmerge((_CUR._SL),p_index)._RESULT;
        ;
        t=CONC(t,tout);
        ;
        ...
        while((RTS_TXT.length(t)>(78))) {
            {
                ...
                new ERRMSG_printDiag((_CUR._SL),tout);
                ;
            }
        }
        ;
        // JavaLine 98 <== SourceLine 76
        new ERRMSG_printDiag((_CUR._SL),t);
        ;
        // JavaLine 101 <== SourceLine 77
        if(_VALUE((p_ec==(((char)1))))) {
            ((ERRMSG)(_CUR._SL)).numwarnfound_1=(((ERRMSG)(_CUR._SL)).numwarnfound_1+(1));
        }
        ;
        ...
        if(_VALUE((p_ec==(((char)2))))) {
            {
                ...
                ((ERRMSG)(_CUR._SL)).numerrfound=(((ERRMSG)(_CUR._SL)).numerrfound+(1));
                ;
                // JavaLine 112 <== SourceLine 80
                if(_VALUE((((ERRMSG)(_CUR._SL)).termstatus<('5')))) {
                    ((ERRMSG)(_CUR._SL)).termstatus='5';
                }
                ;
                // JavaLine 117 <== SourceLine 81
                RTS_ENVIRONMENT.giveIntInfo(1,(RTS_ENVIRONMENT.rank(((ERRMSG)(_CUR._SL)).termstatus)-(RTS_ENVIRONMENT.rank('0'))));
                ;
            }
        }
        ;
        ...
        if(_VALUE(((((ERRMSG)(_CUR._SL)).numerrfound>(((ERRMSG)(_CUR._SL)).maxerrno_1))|((p_ec>(((char)2))))))) {
            new ERRMSG_AbortCompilation((_CUR._SL));
        }
        ;
        EBLK();
        return(this);
    } // End of Procedure BODY
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("ERRMSG.sim","5 GiveMessage",1,56,12,57,46,58,51,59,54,61,56,62,58,63,66,65,71,67,76,69,79,70,82,71,87,72,92,73,98,76,101,77,106,78,109,79,112,80,117,81,123,83,126,84,133,85);
} // End of Procedure
