...
public class SCODMAIN extends PAS2INIT {
    // ClassDeclaration: Kind=8, BlockLevel=1, PrefixLevel=17, firstLine=3, lastLine=3563, hasLocalClasses=true, System=false, detachUsed=false
