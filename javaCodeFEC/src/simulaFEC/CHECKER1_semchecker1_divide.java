...
public class CHECKER1_semchecker1_divide extends CHECKER1_semchecker1_arithop {
    // ClassDeclaration: Kind=8, BlockLevel=3, PrefixLevel=3, firstLine=487, lastLine=492, hasLocalClasses=false, System=false, detachUsed=false
    ...
    // Normal Constructor
    public CHECKER1_semchecker1_divide(RTS_RTObject staticLink,CHECKER1_semchecker1_exp sp_pred,char sp_ch,CHECKER1_semchecker1_exp sp1_left,CHECKER1_semchecker1_exp sp1_right) {
    ...
    // Class Statements
    @Override
    public CHECKER1_semchecker1_divide _STM() {
        CHECKER1_semchecker1_divide _THIS=(CHECKER1_semchecker1_divide)_CUR;
        _LOOP:while(_JTX>=0) {
            try {
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("CHECKER1.sim","8 divide",1,487,10,461,26,169,28,223,30,443,34,444,40,445,43,446,49,448,52,449,55,450,68,452,71,453,74,454,79,456,84,457,86,459,95,461,107,465,113,466,115,467,125,469,127,470,130,471,139,474,141,491,146,492,161,492);
} // End of Class
