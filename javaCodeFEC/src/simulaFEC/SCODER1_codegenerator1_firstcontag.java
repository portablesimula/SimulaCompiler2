...
public final class SCODER1_codegenerator1_firstcontag extends RTS_PROCEDURE {
...
public Object _RESULT() { return(_RESULT); }
    ...
    public COMMON_brecord _inspect_762_4629=null;
    // JavaLine 17 <== SourceLine 752
    public int _RESULT=0;
    // Parameter Transmission in case of Formal/Virtual Procedure Call
    @Override
    public SCODER1_codegenerator1_firstcontag setPar(Object param) {
        try {
            switch(_nParLeft--) {
    ...
    public SCODER1_codegenerator1_firstcontag(RTS_RTObject _SL) {
        super(_SL,1); // Expecting 1 parameters
    }
    // Normal Constructor
    public SCODER1_codegenerator1_firstcontag(RTS_RTObject _SL,COMMON_quantity sp_q) {
        super(_SL);
    ...
    @Override
    public SCODER1_codegenerator1_firstcontag _STM() {
        ...
        if(_VALUE(((p_q.kind_1==(((char)5)))||((p_q.kind_1==(((char)9))))))) {
            {
                // JavaLine 53 <== SourceLine 762
                {
                    ...
                    if(_inspect_762_4629!=null) { // INSPECT _inspect_762_4629
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("SCODER1.sim","5 firstcontag",1,752,13,753,15,762,17,752,47,760,50,761,53,762,58,763,60,762,62,763,66,764,70,765,74,766,80,767,93,779);
} // End of Procedure
