...
public final class SCANNER_W3 extends RTS_PROCEDURE {
    ...
    @Override
    public SCANNER_W3 setPar(Object param) {
        try {
            switch(_nParLeft--) {
    ...
    public SCANNER_W3(RTS_RTObject _SL) {
        super(_SL,2); // Expecting 2 parameters
    }
    // Normal Constructor
    public SCANNER_W3(RTS_RTObject _SL,RTS_TXT sp_t,char sp_i1) {
        super(_SL);
    ...
    @Override
    public SCANNER_W3 _STM() {
        // JavaLine 44 <== SourceLine 95
        {
            // BEGIN INSPECTION 
            _inspect_95_4465=RTS_BASICIO.sysout();
            if(_inspect_95_4465!=null) { // INSPECT _inspect_95_4465
                // JavaLine 49 <== SourceLine 96
                {
                    {
                        new SCANNER_WWW((_CUR._SL),p_t);
                        ;
                        _inspect_95_4465.outtext(((SCANNER)(_CUR._SL)).DB.getELEMENT(RTS_ENVIRONMENT.rank(p_i1)));
                        ;
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("SCANNER.sim","5 W3",1,95,12,96,44,95,49,96,64,96);
} // End of Procedure
