...
public class COMMON extends RTS_CLASS {
    // ClassDeclaration: Kind=8, BlockLevel=1, PrefixLevel=0, firstLine=1, lastLine=1322, hasLocalClasses=true, System=false, detachUsed=false
    ...
    public RTS_REF_ARRAY<COMMON_symbolgroup> symtab=null;
    // JavaLine 24 <== SourceLine 46
    public RTS_REF_ARRAY<COMMON_symbolbox> hashtab=null;
    // JavaLine 26 <== SourceLine 51
    public COMMON_symbolgroup dummyGroup=null;
    public COMMON_identsymbol dummyBox=null;
    ...
    public COMMON_component scanner=null;
    public COMMON_component parser=null;
    // JavaLine 591 <== SourceLine 342
    public COMMON_outcodefile coder=null;
    // JavaLine 593 <== SourceLine 344
    public COMMON_quantity setprefgoing=null;
    public COMMON_quantity alloc2called=null;
    // JavaLine 596 <== SourceLine 345
    public COMMON_brecord unknowns=null;
    ...
    public COMMON_TAGTABLE TAGTAB=null;
...
public RTS_PRCQNT ENDCOMP_0(){ throw new RTS_SimulaRuntimeError("No Virtual Match: ENDCOMP"); }
    // Normal Constructor
    public COMMON(RTS_RTObject staticLink) {
        super(staticLink);
        // Parameter assignment to locals
        BBLK(); // Iff no prefix
        // Declaration Code
        // JavaLine 652 <== SourceLine 41
        symtab=new RTS_REF_ARRAY<COMMON_symbolgroup>(new RTS_BOUNDS(0,127));
        // JavaLine 654 <== SourceLine 46
        hashtab=new RTS_REF_ARRAY<COMMON_symbolbox>(new RTS_BOUNDS(0,255));
        // JavaLine 656 <== SourceLine 245
        option=new RTS_CHARACTER_ARRAY(new RTS_BOUNDS(0,95));
        // JavaLine 658 <== SourceLine 368
        brctab=new RTS_REF_ARRAY<COMMON_brctab2>(new RTS_BOUNDS(0,127));
        // JavaLine 660 <== SourceLine 369
        prefixchain=new RTS_REF_ARRAY<COMMON_quantity>(new RTS_BOUNDS(0,64));
        // JavaLine 662 <== SourceLine 370
        display=new RTS_REF_ARRAY<COMMON_brecord>(new RTS_BOUNDS(0,63));
