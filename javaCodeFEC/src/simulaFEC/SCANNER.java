...
public class SCANNER extends ERRMSG {
    ...
    public SCANNER_L2Coder P1coder_2=null;
    // Normal Constructor
    public SCANNER(RTS_RTObject staticLink) {
        super(staticLink);
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("SCANNER.sim","8 SCANNER",1,3,10,20,12,21,14,25,16,26,18,27,20,28,22,29,24,30,26,31,28,32,30,33,32,34,34,37,36,38,38,39,40,462,42,463,44,464,46,466,48,1557,55,466,61,1322,63,998,65,2395,72,2395);
} // End of Class
