...
public final class SCANNER_W1 extends RTS_PROCEDURE {
    ...
    @Override
    public SCANNER_W1 setPar(Object param) {
        try {
            switch(_nParLeft--) {
    ...
    public SCANNER_W1(RTS_RTObject _SL) {
        super(_SL,2); // Expecting 2 parameters
    }
    // Normal Constructor
    public SCANNER_W1(RTS_RTObject _SL,RTS_TXT sp_t,int sp_i) {
        super(_SL);
    ...
    @Override
    public SCANNER_W1 _STM() {
        // JavaLine 44 <== SourceLine 92
        {
            // BEGIN INSPECTION 
            _inspect_92_4464=RTS_BASICIO.sysout();
            if(_inspect_92_4464!=null) { // INSPECT _inspect_92_4464
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("SCANNER.sim","5 W1",1,92,12,93,44,92,49,93,64,93);
} // End of Procedure
