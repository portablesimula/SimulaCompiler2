...
public final class SCANNER_SetSelectors extends RTS_PROCEDURE {
    ...
    @Override
    public SCANNER_SetSelectors setPar(Object param) {
        try {
            switch(_nParLeft--) {
    ...
    public SCANNER_SetSelectors(RTS_RTObject _SL) {
        super(_SL,2); // Expecting 2 parameters
    }
    // Normal Constructor
    public SCANNER_SetSelectors(RTS_RTObject _SL,RTS_TXT sp_t,int sp_val) {
        super(_SL);
    ...
    @Override
    public SCANNER_SetSelectors _STM() {
        // JavaLine 45 <== SourceLine 471
        if(_VALUE((p_val==(0)))) {
            for(i=47;i<=127;i++) {
                // JavaLine 48 <== SourceLine 472
                ((SCANNER)(_CUR._SL)).selector.putELEMENT(((SCANNER)(_CUR._SL)).selector.index(i),false);
            }
        }
        ;
        ...
        while(RTS_TXT.more(p_t)) {
            {
                ...
                if(_VALUE((i>(47)))) {
                    ((SCANNER)(_CUR._SL)).selector.putELEMENT(((SCANNER)(_CUR._SL)).selector.index(i),b);
                }
                ;
            }
        }
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("SCANNER.sim","5 SetSelectors",1,469,12,470,45,471,48,472,53,473,58,474,61,475,68,476,78,478);
} // End of Procedure
