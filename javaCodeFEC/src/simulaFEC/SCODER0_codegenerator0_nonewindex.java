...
public final class SCODER0_codegenerator0_nonewindex extends RTS_PROCEDURE {
...
public Object _RESULT() { return(_RESULT); }
    ...
    final RTS_LABEL _LABEL_SCODER0_codegenerator0_nonewindex_EXIT_0=new RTS_LABEL(this,0,1,"EXIT"); // Local Label #1=EXIT At PrefixLevel 0
    ...
    // Normal Constructor
    public SCODER0_codegenerator0_nonewindex(RTS_RTObject _SL) {
        super(_SL);
    ...
    @Override
    public SCODER0_codegenerator0_nonewindex _STM() {
        SCODER0_codegenerator0_nonewindex _THIS=(SCODER0_codegenerator0_nonewindex)_CUR;
        _LOOP:while(_JTX>=0) {
            try {
                ...
                i=((SCODER0_codegenerator0)(_CUR._SL)).freeindex_5;
                ;
                ...
                while((j!=(0))) {
                    {
                        ...
                        if(_VALUE((i==(0)))) {
                            {
                                _RESULT=true;
                                ;
                                _GOTO(_LABEL_SCODER0_codegenerator0_nonewindex_EXIT_0); // GOTO EVALUATED LABEL
                            }
                        }
                        ;
                        ...
                        j=(j-(1));
                        ;
                        i=((SCODER0_codegenerator0)(_CUR._SL)).indexused.getELEMENT(i);
                        ;
                    }
                }
                ;
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("SCODER0.sim","5 nonewindex",1,171,12,184,15,173,18,171,35,176,38,177,41,178,44,179,53,180,61,182,64,183,69,184,83,184);
} // End of Procedure
