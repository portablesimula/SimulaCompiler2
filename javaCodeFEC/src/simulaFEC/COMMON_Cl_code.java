...
public final class COMMON_Cl_code extends RTS_PROCEDURE {
...
public Object _RESULT() { return(_RESULT); }
    ...
    @Override
    public COMMON_Cl_code setPar(Object param) {
        try {
            switch(_nParLeft--) {
    ...
    public COMMON_Cl_code(RTS_RTObject _SL) {
        super(_SL,1); // Expecting 1 parameters
    }
    // Normal Constructor
    public COMMON_Cl_code(RTS_RTObject _SL,char sp_k) {
        super(_SL);
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("COMMON.sim","5 Cl_code",1,294,13,295,15,294,45,296,48,297,51,299,56,300,61,301);
} // End of Procedure
