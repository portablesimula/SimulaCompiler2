...
public boolean isDetachUsed() { return(true); }
    ...
    // Normal Constructor
    public SCANNER_recognizer_identifierScanner(RTS_RTObject staticLink) {
        super(staticLink);
    ...
    // Class Statements
    @Override
    public SCANNER_recognizer_identifierScanner _STM() {
        SCANNER_recognizer_identifierScanner _THIS=(SCANNER_recognizer_identifierScanner)_CUR;
        _LOOP:while(_JTX>=0) {
            try {
                ...
                while(true) {
                    {
                        ...
                        {
                            _SIM_LABEL(1); // DeclaredIn: identifierScanner -> identifierScanner[SCANNER_recognizer_identifierScanner] DeclarationKind=Class
                            ...
                            switch(((SCANNER_recognizer)(_CUR._SL)).InputClass.getELEMENT(RTS_ENVIRONMENT.rank(((SCANNER_recognizer)(_CUR._SL)).atom_1))) { // BEGIN SWITCH STATEMENT
                                ...
                                // JavaLine 59 <== SourceLine 913
                                {
                                    ...
                                    RTS_ENVIRONMENT.storeChar(((SCANNER_recognizer)(_CUR._SL)).atom_1,hashbuf,hashpos);
                                    ;
                                    hashpos=(hashpos+(1));
                                    ;
                                    // JavaLine 66 <== SourceLine 915
                                    {
                                        _SIM_LABEL(2); // DeclaredIn: identifierScanner -> identifierScanner[SCANNER_recognizer_identifierScanner] DeclarationKind=Class
                                    ...
                                    if(_VALUE((((SCANNER_recognizer)(_CUR._SL)).linepos_1>(((SCANNER_recognizer)(_CUR._SL)).linelength_1)))) {
                                        new ERRMSG_internerr((_CUR._SL._SL),((char)2),916);
                                    }
                                    ;
                        ...
                        {
                            _SIM_LABEL(3); // DeclaredIn: identifierScanner -> identifierScanner[SCANNER_recognizer_identifierScanner] DeclarationKind=Class
                            ((SCANNER)(_CUR._SL._SL)).simsymbol=RTS_ENVIRONMENT.lowcase(RTS_TXT.sub(hashbuf,1,hashpos));
                        }
                        ;
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("SCANNER.sim","8 identifierScanner",1,900,11,912,13,915,15,926,18,903,20,904,22,905,38,907,43,908,46,909,49,911,52,912,59,913,61,914,66,915,74,916,79,917,86,919,88,920,93,921,102,922,106,923,112,926,118,928,125,932,137,932);
} // End of Class
