...
public final class COMMON_quantity_dump_outblno extends RTS_PROCEDURE {
    ...
    @Override
    public COMMON_quantity_dump_outblno setPar(Object param) {
        try {
            switch(_nParLeft--) {
    ...
    public COMMON_quantity_dump_outblno(RTS_RTObject _SL) {
        super(_SL,1); // Expecting 1 parameters
    }
    // Normal Constructor
    public COMMON_quantity_dump_outblno(RTS_RTObject _SL,COMMON_brecord sp_brc) {
        super(_SL);
    ...
    @Override
    public COMMON_quantity_dump_outblno _STM() {
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("COMMON.sim","5 outblno",1,703,39,704,44,705,51,706);
} // End of Procedure
