...
public final class BUILDER2_prechecker_allocate_alloc2 extends RTS_PROCEDURE {
    ...
    final RTS_LABEL _LABEL_BUILDER2_prechecker_allocate_alloc2_Block1469_Block1493_Block1502_NXTVA_0=new RTS_LABEL(this,0,1,"NXTVA"); // Local Label #1=NXTVA At PrefixLevel 0
    // JavaLine 13 <== SourceLine 1600
    final RTS_LABEL _LABEL_BUILDER2_prechecker_allocate_alloc2_EXBIND_0=new RTS_LABEL(this,0,2,"EXBIND"); // Local Label #2=EXBIND At PrefixLevel 0
    // JavaLine 15 <== SourceLine 1638
    final RTS_LABEL _LABEL_BUILDER2_prechecker_allocate_alloc2_Block1635_Block1636_CH_0=new RTS_LABEL(this,0,3,"CH"); // Local Label #3=CH At PrefixLevel 0
    // JavaLine 17 <== SourceLine 1651
    final RTS_LABEL _LABEL_BUILDER2_prechecker_allocate_alloc2_LBL_0=new RTS_LABEL(this,0,4,"LBL"); // Local Label #4=LBL At PrefixLevel 0
    // Declare locals as attributes
    // JavaLine 20 <== SourceLine 1297
    public COMMON_quantity Q=null;
    public COMMON_quantity QX=null;
    public COMMON_quantity VA=null;
    public COMMON_quantity VB=null;
    public COMMON_quantity VC=null;
    public COMMON_brecord B=null;
    public COMMON_idpack fvis=null;
    // JavaLine 28 <== SourceLine 1298
    public int VNO=0;
    // JavaLine 30 <== SourceLine 1547
    public COMMON_quantity _inspect_1547_4548=null;
    // JavaLine 32 <== SourceLine 1561
    public COMMON_brecord _inspect_1561_4549=null;
    // Parameter Transmission in case of Formal/Virtual Procedure Call
    @Override
    public BUILDER2_prechecker_allocate_alloc2 setPar(Object param) {
        try {
            switch(_nParLeft--) {
    ...
    public BUILDER2_prechecker_allocate_alloc2(RTS_RTObject _SL) {
        super(_SL,1); // Expecting 1 parameters
    }
    // Normal Constructor
    public BUILDER2_prechecker_allocate_alloc2(RTS_RTObject _SL,COMMON_brecord sp_brc) {
        super(_SL);
    ...
    @Override
    public BUILDER2_prechecker_allocate_alloc2 _STM() {
        BUILDER2_prechecker_allocate_alloc2 _THIS=(BUILDER2_prechecker_allocate_alloc2)_CUR;
        _LOOP:while(_JTX>=0) {
            try {
                ...
                if(_VALUE(((p_brc.kind==(((char)5)))||((p_brc.kind==(((char)7))))))) {
                    {
                        ...
                        p_brc.declquant.match_1=((BUILDER2)(_CUR._SL._SL._SL)).alloc2called;
                        ;
                        ...
                        if(_VALUE((p_brc.declquant.plev_1>(1)))) {
                            {
                                ...
                                if(_VALUE((B.declquant.match_1!=(((BUILDER2)(_CUR._SL._SL._SL)).alloc2called)))) {
                                    new BUILDER2_prechecker_allocate_alloc2((_CUR._SL),B);
                                }
                                ;
                                ...
                                new COMMON_TRC((_CUR._SL._SL._SL),new RTS_TXT("BUILDER2"),1434,CONC(CONC(CONC(CONC(CONC(CONC(CONC(new RTS_TXT("NPAR+PREFIX: "),p_brc.declquant.symb_1.symbol),new RTS_TXT(".npar=")),RTS_ENVIRONMENT.edit(p_brc.npar)),new RTS_TXT(", ")),B.declquant.symb_1.symbol),new RTS_TXT(".npar=")),RTS_ENVIRONMENT.edit(B.npar)));
                                ;
                            ...
                            // JavaLine 94 <== SourceLine 1437
                            {
                                ...
                                Q=new COMMON_quantity((_CUR._SL._SL._SL))._STM();
                                ;
                                // JavaLine 99 <== SourceLine 1439
                                new BUILDER1_precheck0_makeequalto((_CUR._SL._SL),p_brc.declquant,Q);
                                ;
                                ...
                                B=new COMMON_brecord((_CUR._SL._SL._SL))._STM();
                                ;
                                ...
                                B.blnohi=((BUILDER2_prechecker)(_CUR._SL._SL)).lastblhi;
                                ;
                                B.blnolo=((BUILDER2_prechecker)(_CUR._SL._SL)).lastbllo;
                                ;
                                ...
                                if(_VALUE((((BUILDER2_prechecker)(_CUR._SL._SL)).detachquant!=(null)))) {
                                    {
                                        ...
                                        if(_VALUE((p_brc.kind==(((char)5))))) {
                                            {
                                                ...
                                                new BUILDER1_precheck0_makeequalto((_CUR._SL._SL),((BUILDER2_prechecker)(_CUR._SL._SL)).detachquant,QX);
                                                ;
                                ...
                                new COMMON_QTRC((_CUR._SL._SL._SL),new RTS_TXT("BUILDER2"),1457,new RTS_TXT("NEW Quantity: "),Q);
                                ;
                            }
                        }
                        ;
                ...
                if(_VALUE((p_brc.fpar!=(null)))) {
                    {
                        ...
                        new BUILDER2_normalattrfile_expandexternals(((BUILDER2)(_CUR._SL._SL._SL)).Afile_7,p_brc);
                        ;
                        // JavaLine 172 <== SourceLine 1463
                        if(_VALUE((((BUILDER2)(_CUR._SL._SL._SL)).option.getELEMENT(RTS_ENVIRONMENT.rank('P'))!=(((char)0))))) {
                            // JavaLine 174 <== SourceLine 1464
                            new SCANNER_dump((_CUR._SL._SL._SL),new RTS_TXT("- after exp.externals"));
                        }
                        ;
                    }
                }
                ...
                if(_VALUE(((p_brc.kind==(((char)5)))||((p_brc.kind==(((char)9))))))) {
                    {
                        ...
                        if(_VALUE((p_brc.declquant.plev_1>(1)))) {
                            // JavaLine 186 <== SourceLine 1470
                            {
                                ...
                                new BUILDER1_precheck0_hide((_CUR._SL._SL),p_brc.declquant.prefqual_1,false);
                                ;
                                ...
                                while((VC!=(null))) {
                                    {
                                        ...
                                        QX=((_IS(VC,COMMON_quantity.class))?(new COMMON_quantity((_CUR._SL._SL._SL))._STM()):(new COMMON_extquantity((_CUR._SL._SL._SL),null)._STM()));
                                        ;
                                        ...
                                        if(_VALUE((VA==(null)))) {
                                            ...
                                            VB=((COMMON_quantity)(VB.next=QX));
                                        }
                                        ;
                                        // JavaLine 214 <== SourceLine 1484
                                        new BUILDER1_precheck0_makeequalto((_CUR._SL._SL),VC,VB);
                                        ;
                                        // JavaLine 217 <== SourceLine 1485
                                        new COMMON_QTRC((_CUR._SL._SL._SL),new RTS_TXT("BUILDER2"),1485,new RTS_TXT("NEW Quantity: "),QX);
                                        ;
                                ...
                                while((VC!=(null))) {
                                    // JavaLine 262 <== SourceLine 1501
                                    {
                                        ...
                                        while(((VA!=(VC))&&((VA.symb_1!=(VC.symb_1))))) {
                                            ...
                                            {
                                                _SIM_LABEL(1); // DeclaredIn: alloc2 -> alloc2[externalIdent=BUILDER2_prechecker_allocate_alloc2] Kind=5, QUAL=ProcedureDeclaration, HashCode=1039835620
                                                VA=((COMMON_quantity)(VA.next));
                                            }
                                        }
                                        ;
                                        ...
                                        if(_VALUE((VA!=(VC)))) {
                                            {
                                                ...
                                                if(_VALUE((VA.visible_1!=(((char)0))))) {
                                                    _GOTO(_LABEL_BUILDER2_prechecker_allocate_alloc2_Block1469_Block1493_Block1502_NXTVA_0); // GOTO EVALUATED LABEL
                                                }
                                                ;
                                                // JavaLine 284 <== SourceLine 1508
                                                new ERRMSG_errQTN((_CUR._SL._SL._SL),VC,414,VA);
                                                ;
                                            ...
                                            if(_VALUE(((VC.kind_1!=(((char)1)))&&((VC.type_1!=(((char)11))))))) {
                                                ...
                                                {
                                                    new ERRMSG_errQT((_CUR._SL._SL._SL),VC,326);
                                                    ;
                ...
                if(_VALUE((Q!=(null)))) {
                    {
                        ...
                        Q=new BUILDER2_prechecker_allocate_alloc2_setprefqual((_CUR),Q,true)._RESULT;
                        ;
                    }
                }
                ;
                ...
                if(_VALUE(((p_brc.kind==(((char)11)))||((p_brc.kind==(((char)7))))))) {
                    // JavaLine 354 <== SourceLine 1532
                    {
                        ...
                        new BUILDER1_precheck0_vischain((_CUR._SL._SL),p_brc.fpar,VC);
                        ;
                    }
                } else {
                    // JavaLine 361 <== SourceLine 1536
                    {
                        ...
                        ((BUILDER2)(_CUR._SL._SL._SL)).cblev_6=RTS_ENVIRONMENT._char((RTS_ENVIRONMENT.rank(((BUILDER2)(_CUR._SL._SL._SL)).cblev_6)+(1)));
                        ;
                        ((BUILDER2)(_CUR._SL._SL._SL)).crtblev_6=RTS_ENVIRONMENT._char((RTS_ENVIRONMENT.rank(((BUILDER2)(_CUR._SL._SL._SL)).crtblev_6)+(1)));
                        ;
                        // JavaLine 368 <== SourceLine 1538
                        if(_VALUE((RTS_ENVIRONMENT.rank(((BUILDER2)(_CUR._SL._SL._SL)).cblev_6)>(250)))) {
                            new ERRMSG_fatal0((_CUR._SL._SL._SL),299);
                        }
                        ;
                        // JavaLine 373 <== SourceLine 1539
                        new BUILDER1_precheck0_makevisblock((_CUR._SL._SL),p_brc);
                        ;
                    }
                }
                ;
                ...
                if(_VALUE((QX!=(null)))) {
                    new BUILDER2_prechecker_allocate_alloc2_setprefqual((_CUR),QX,false);
                }
                ;
                // JavaLine 384 <== SourceLine 1543
                if(_VALUE((Q!=(null)))) {
                    new BUILDER2_prechecker_allocate_alloc2_setprefqual((_CUR),Q,false);
                }
                ;
                ...
                while(true) {
                    {
                        ...
                        if(_inspect_1547_4548!=null) { // INSPECT _inspect_1547_4548
                            // JavaLine 398 <== SourceLine 1548
                            {
                                // JavaLine 400 <== SourceLine 1547
                                {
                                            ...
                                            if(_VALUE((VA!=(null)))) {
                                                {
                                                    ...
                                                    if(_VALUE((((((_inspect_1547_4548.type_1==(((char)15)))&&(((VA.kind_1==(((char)1)))||((VA.type_1==(((char)11)))))))||(((((_inspect_1547_4548.kind_1==(((char)1)))&&((VA.kind_1==(((char)1)))))&&((VA.categ_1!=(((char)4)))))&&(new BUILDER1_precheck0_subordinate((_CUR._SL._SL),VA,((COMMON_quantity)_inspect_1547_4548))._RESULT))))||(((_inspect_1547_4548.kind_1==(((char)3)))&&((VA.kind_1==(((char)3)))))))||(((_inspect_1547_4548.kind_1==(((char)4)))&&((VA.kind_1==(((char)4))))))))) {
                                                        // JavaLine 419 <== SourceLine 1560
                                                        {
                                                            // JavaLine 421 <== SourceLine 1561
                                                            {
                                                                ...
                                                                if(_inspect_1561_4549!=null) { // INSPECT _inspect_1561_4549
                                                                    // JavaLine 426 <== SourceLine 1562
                                                                    {
                                                                        // JavaLine 428 <== SourceLine 1561
                                                                        new BUILDER2_prechecker_allocate_alloc2_Block1548_Block1549_Block1553_Block1561_Block1563((_CUR))._STM();
                                                                    }
                                                                }
                                                            } // END INSPECTION
                                                            ;
                                                            // JavaLine 434 <== SourceLine 1589
                                                            VA.match_1=((COMMON_quantity)_inspect_1547_4548);
                                                            ;
                                                        ...
                                                        new ERRMSG_errQTN((_CUR._SL._SL._SL),VA,415,((COMMON_quantity)_inspect_1547_4548));
                                                    }
                                                    ;
                                                }
                                            }
                                    ...
                                    VC=((COMMON_quantity)(_inspect_1547_4548.next));
                                    ;
                                }
                            }
                        }
                            ...
                            _GOTO(_LABEL_BUILDER2_prechecker_allocate_alloc2_EXBIND_0); // GOTO EVALUATED LABEL
                        } // END OTHERWISE 
                    } // END INSPECTION
                ...
                ;
                {
                    ...
                    if(_VALUE((((BUILDER2)(_CUR._SL._SL._SL)).option.getELEMENT(RTS_ENVIRONMENT.rank('P'))!=(((char)0))))) {
                        new SCANNER_dump((_CUR._SL._SL._SL),new RTS_TXT("- after VIRT binding"));
                    }
                }
                ;
                // JavaLine 480 <== SourceLine 1603
                if(_VALUE(((((BUILDER2_prechecker)(_CUR._SL._SL)).detachquant==(null))&&((p_brc.blev==(((char)2))))))) {
                    {
                        // JavaLine 483 <== SourceLine 1604
                        ((BUILDER2_prechecker)(_CUR._SL._SL)).detachquant=((COMMON_quantity)(((COMMON_identsymbol)(new COMMON_boxof((_CUR._SL._SL._SL),((char)0),'D')._RESULT)).curmeaning_1));
                        ;
                        // JavaLine 486 <== SourceLine 1606
                        if(_VALUE((((BUILDER2_prechecker)(_CUR._SL._SL)).detachquant==(null)))) {
                            // JavaLine 488 <== SourceLine 1607
                            ((BUILDER2_prechecker)(_CUR._SL._SL)).detachquant=new ERRMSG_newnotseen((_CUR._SL._SL._SL),new COMMON_boxof((_CUR._SL._SL._SL),((char)0),'D')._RESULT)._RESULT;
                        }
                        ;
                    }
                }
                ...
                while((Q!=(null))) {
                    {
                        ...
                        switch(Q.kind_1) { // BEGIN SWITCH STATEMENT
                            ...
                            if(_VALUE(((Q.categ_1==(((char)3)))||((Q.categ_1==(((char)4))))))) {
                                ...
                                new BUILDER2_prechecker_allocate_alloc2((_CUR._SL),Q.descr_1);
                            }
                            break;
                            case 5: 
                            case 7: 
                            // JavaLine 513 <== SourceLine 1620
                            if(_VALUE((Q.match_1!=(((BUILDER2)(_CUR._SL._SL._SL)).alloc2called)))) {
                                new BUILDER2_prechecker_allocate_alloc2((_CUR._SL),Q.descr_1);
                            }
                            break;
                ...
                switch(p_brc.kind) { // BEGIN SWITCH STATEMENT
                    ...
                    // JavaLine 531 <== SourceLine 1631
                    {
                        ...
                        Q=p_brc.fpar;
                        ;
                        new BUILDER1_precheck0_invischain((_CUR._SL._SL),Q);
                        ;
                    }
                    break;
                    case 5: 
                    // JavaLine 541 <== SourceLine 1633
                    {
                        ...
                        if(_VALUE((p_brc.hidlist!=(null)))) {
                            {
                                ...
                                new BUILDER1_precheck0_unprotect((_CUR._SL._SL),p_brc.declquant);
                                ;
                                B=p_brc;
                                ;
                                // JavaLine 551 <== SourceLine 1637
                                new BUILDER2_prechecker_allocate_alloc2_checkhid((_CUR),p_brc.favirt);
                                ;
                                // JavaLine 554 <== SourceLine 1638
                                {
                                    _SIM_LABEL(3); // DeclaredIn: alloc2 -> alloc2[externalIdent=BUILDER2_prechecker_allocate_alloc2] Kind=5, QUAL=ProcedureDeclaration, HashCode=1039835620
                                    new BUILDER2_prechecker_allocate_alloc2_checkhid((_CUR),B.fpar);
                                }
                                ;
                                ...
                                if(_VALUE((B.declquant.plev_1>(1)))) {
                                    {
                                        ...
                                        new BUILDER1_precheck0_unprotect((_CUR._SL._SL),B.declquant);
                                        ;
                                        _GOTO(_LABEL_BUILDER2_prechecker_allocate_alloc2_Block1635_Block1636_CH_0); // GOTO EVALUATED LABEL
                                    }
                                }
                                ;
                                ...
                                while((fvis!=(null))) {
                                    {
                                        ...
                                        if(_VALUE((fvis.line>(0)))) {
                                            new ERRMSG_removeVis((_CUR._SL._SL._SL),p_brc,fvis,368);
                                        } else {
                        ...
                        _GOTO(_LABEL_BUILDER2_prechecker_allocate_alloc2_LBL_0); // GOTO EVALUATED LABEL
                    }
                    break;
                    default:
                    // JavaLine 600 <== SourceLine 1651
                    {
                        ...
                        new BUILDER1_precheck0_leaveblock((_CUR._SL._SL));
                    }
                    break;
                } // END SWITCH STATEMENT
                ;
                // JavaLine 608 <== SourceLine 1653
                new COMMON_brecord_blockDump(p_brc,CONC(CONC(new RTS_TXT("Builder2.LINE "),RTS_ENVIRONMENT.edit(1653)),new RTS_TXT(": END Alloc2 ")));
                ;
                break _LOOP;
            }
            catch(RTS_LABEL q) {
