...
public class SCODER1 extends SCODER0 {
    // ClassDeclaration: Kind=8, BlockLevel=1, PrefixLevel=11, firstLine=3, lastLine=903, hasLocalClasses=true, System=false, detachUsed=false
    ...
    // Normal Constructor
    public SCODER1(RTS_RTObject staticLink) {
        super(staticLink);
