...
public final class SCANNER_recognizer_ScanPastFormat extends RTS_PROCEDURE {
    ...
    // Normal Constructor
    public SCANNER_recognizer_ScanPastFormat(RTS_RTObject _SL) {
        super(_SL);
    ...
    @Override
    public SCANNER_recognizer_ScanPastFormat _STM() {
        SCANNER_recognizer_ScanPastFormat _THIS=(SCANNER_recognizer_ScanPastFormat)_CUR;
        _LOOP:while(_JTX>=0) {
            try {
                ...
                // JavaLine 36 <== SourceLine 810
                {
                    ...
                    if(((SCANNER_recognizer)(_CUR._SL)).InputClass.getELEMENT(RTS_ENVIRONMENT.rank(((SCANNER_recognizer)(_CUR._SL)).atom_1))<((char)0) || ((SCANNER_recognizer)(_CUR._SL)).InputClass.getELEMENT(RTS_ENVIRONMENT.rank(((SCANNER_recognizer)(_CUR._SL)).atom_1))>((char)9)) throw new RTS_SimulaRuntimeError("Switch key outside key interval");
                    switch(((SCANNER_recognizer)(_CUR._SL)).InputClass.getELEMENT(RTS_ENVIRONMENT.rank(((SCANNER_recognizer)(_CUR._SL)).atom_1))) { // BEGIN SWITCH STATEMENT
                        case 7: 
                        case 8: 
                        // JavaLine 43 <== SourceLine 811
                        {
                            // JavaLine 45 <== SourceLine 812
                            if(_VALUE(((((SCANNER_recognizer)(_CUR._SL)).atom_1==(((char)7)))&&((((SCANNER_recognizer)(_CUR._SL)).linepos_1==(((SCANNER_recognizer)(_CUR._SL)).linelength_1)))))) {
                                // JavaLine 47 <== SourceLine 815
                                {
                                    new SCANNER_recognizer_nextLine((_CUR._SL));
                                    ;
                                    _GOTO(_LABEL_SCANNER_recognizer_ScanPastFormat_SCN1_0); // GOTO EVALUATED LABEL
                                }
                            }
                            ;
                            // JavaLine 55 <== SourceLine 816
                            if(_VALUE((((SCANNER)(_CUR._SL._SL)).maxnumoftags>(0)))) {
                        ...
                        // JavaLine 65 <== SourceLine 819
                        {
                            ...
                            ;
                            call(((SCANNER_recognizer)(_CUR._SL)).IdScanner_1,820);
                            ;
                            // JavaLine 72 <== SourceLine 821
                            if(_VALUE(_TXTREL_NE(((SCANNER)(_CUR._SL._SL)).simsymbol,new RTS_TXT("comment")))) {
                                {
                                    // JavaLine 75 <== SourceLine 822
                                    ((SCANNER_recognizer)(_CUR._SL)).linepos_1=startpos;
                                    ;
                                    ((SCANNER_recognizer)(_CUR._SL)).atom_1='c';
                                    ;
                                    _GOTO(_LABEL_SCANNER_recognizer_ScanPastFormat_EXIT_0); // GOTO EVALUATED LABEL
                                }
                            }
                            ;
                        ...
                        // JavaLine 119 <== SourceLine 831
                        {
                            ...
                            if(_VALUE((((SCANNER_recognizer)(_CUR._SL)).linepos_1>(((SCANNER_recognizer)(_CUR._SL)).linelength_1)))) {
                                ...
                                new ERRMSG_internerr((_CUR._SL._SL),((char)2),834);
                            }
                            ;
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("SCANNER.sim","5 ScanPastFormat",1,806,10,810,12,825,14,832,16,838,19,808,36,810,43,811,45,812,47,815,55,816,60,818,65,819,67,820,72,821,75,822,84,823,89,824,93,825,96,826,99,827,105,828,113,830,119,831,121,832,129,833,131,834,135,835,142,838,156,838);
} // End of Procedure
