...
public class SCODER4 extends SCODER3 {
    // ClassDeclaration: Kind=8, BlockLevel=1, PrefixLevel=15, firstLine=3, lastLine=494, hasLocalClasses=true, System=false, detachUsed=false
    ...
    // Normal Constructor
    public SCODER4(RTS_RTObject staticLink) {
        super(staticLink);
