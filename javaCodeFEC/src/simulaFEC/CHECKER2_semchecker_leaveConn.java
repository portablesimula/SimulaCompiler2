...
public final class CHECKER2_semchecker_leaveConn extends RTS_PROCEDURE {
    ...
    public COMMON_brecord _inspect_210_4593=null;
    // JavaLine 19 <== SourceLine 214
    public COMMON_brecord _inspect_214_4594=null;
    // JavaLine 21 <== SourceLine 219
    public COMMON_stackedb _inspect_219_4595=null;
    // JavaLine 23 <== SourceLine 236
    public COMMON_brecord _inspect_236_4596=null;
    // Normal Constructor
    public CHECKER2_semchecker_leaveConn(RTS_RTObject _SL) {
        super(_SL);
    ...
    @Override
    public CHECKER2_semchecker_leaveConn _STM() {
        // JavaLine 36 <== SourceLine 210
        {
            // BEGIN INSPECTION 
            _inspect_210_4593=((CHECKER2)(_CUR._SL._SL)).display.getELEMENT(RTS_ENVIRONMENT.rank(((CHECKER2)(_CUR._SL._SL)).cblev_6));
            if(_inspect_210_4593!=null) { // INSPECT _inspect_210_4593
                // JavaLine 41 <== SourceLine 211
                {
                    // JavaLine 43 <== SourceLine 210
                    {
                        ...
                        ;
                        new BUILDER1_precheck0_invischain((_CUR._SL),q);
                        ;
                        ...
                        if(_VALUE((_inspect_210_4593.declquant.prefqual_1!=(null)))) {
                            {
                                // JavaLine 53 <== SourceLine 214
                                {
                                    ...
                                    if(_inspect_214_4594!=null) { // INSPECT _inspect_214_4594
                                                ...
                                                if(_VALUE((_inspect_214_4594.kind==(((char)8))))) {
                                                    {
                                                        ...
                                                        new BUILDER1_precheck0_leaveblock((_CUR._SL));
                                                        ;
                                                    }
                                                } else {
                                                    // JavaLine 70 <== SourceLine 218
                                                    {
                                                        // JavaLine 72 <== SourceLine 219
                                                        {
                                                            ...
                                                            if(_inspect_219_4595!=null) { // INSPECT _inspect_219_4595
                                                                        ...
                                                                        while((chain!=(null))) {
                                                                            {
                                                                                ...
                                                                                ((COMMON_identsymbol)(new COMMON_boxof((_CUR._SL._SL),chain.p1_rehi,chain.p1_relo)._RESULT)).curmeaning_1=chain.prevmeaning;
                                                                                ;
                                                                                // JavaLine 90 <== SourceLine 224
                                                                                chain=((COMMON_stackedi)(chain.next));
                                                                                ;
                                                                            }
                                                                        }
                                                                        ;
                                                        ...
                                                        ((CHECKER2)(_CUR._SL._SL)).prefixchain.putELEMENT(((CHECKER2)(_CUR._SL._SL)).prefixchain.index(1),q=_inspect_214_4594.declquant);
                                                        ;
                                                        opimax=1;
                                                        ;
                                                        ...
                                                        while((opimax<(_inspect_214_4594.declquant.plev_1))) {
                                                            // JavaLine 108 <== SourceLine 229
                                                            {
                                                                ...
                                                                ((CHECKER2)(_CUR._SL._SL)).prefixchain.putELEMENT(((CHECKER2)(_CUR._SL._SL)).prefixchain.index(opimax),q=q.prefqual_1);
                                                                ;
                                                            }
                                                        }
                                                        ;
                                                        ...
                                                        while((q!=(null))) {
                                                            {
                                                                // JavaLine 124 <== SourceLine 236
                                                                {
                                                                    ...
                                                                    if(_inspect_236_4596!=null) { // INSPECT _inspect_236_4596
                                                                        {
                                                        ...
                                                        while((opi!=(0))) {
                                                            {
                                                                ...
                                                                q=((CHECKER2)(_CUR._SL._SL)).prefixchain.getELEMENT(opi);
                                                                ;
                                                                ((CHECKER2)(_CUR._SL._SL)).prefixchain.putELEMENT(((CHECKER2)(_CUR._SL._SL)).prefixchain.index(opi),null);
                                                                ;
                                                        ...
                                                        ((CHECKER2)(_CUR._SL._SL)).display.putELEMENT(((CHECKER2)(_CUR._SL._SL)).display.index(RTS_ENVIRONMENT.rank(((CHECKER2)(_CUR._SL._SL)).cblev_6)),null);
                                                        ;
