...
public final class SCODER1E_codegenerator1e_GenerateSequPPtags extends RTS_PROCEDURE {
    ...
    public BUILDER1_extmodule eee=null;
    // Parameter Transmission in case of Formal/Virtual Procedure Call
    @Override
    public SCODER1E_codegenerator1e_GenerateSequPPtags setPar(Object param) {
        try {
            switch(_nParLeft--) {
    ...
    public SCODER1E_codegenerator1e_GenerateSequPPtags(RTS_RTObject _SL) {
        super(_SL,1); // Expecting 1 parameters
    }
    // Normal Constructor
    public SCODER1E_codegenerator1e_GenerateSequPPtags(RTS_RTObject _SL,COMMON_quantity sp_q) {
        super(_SL);
        ...
        while((qty!=(null))) {
            {
                ...
                if(_VALUE(_IS(qty,COMMON_quantity.class))) {
                    {
                        ...
                        if(_VALUE((((SCODER1E)(_CUR._SL._SL)).simob_level>(3)))) {
                            {
                                ...
                                if(_VALUE((((qty.kind_1==(((char)1)))&&(((qty.categ_1==(((char)3)))||((qty.categ_1==(((char)4)))))))||((qty.kind_1==(((char)5))))))) {
                                    // JavaLine 75 <== SourceLine 66
                                    {
                                        ...
                                        new BUILDER1_newTTag((_CUR._SL._SL),new RTS_TXT("xsobtag"));
                                        // JavaLine 79 <== SourceLine 69
                                        if(_VALUE(((SCODER1E)(_CUR._SL._SL)).simob_descr)) {
                                            {
                                                // JavaLine 82 <== SourceLine 70
                                                ((SCODER1E_codegenerator1e)(_CUR._SL)).outbyte(4);
                                                ;
                                                new SCODER0_codegenerator0_outTagWithIdent((_CUR._SL),((SCODER1E)(_CUR._SL._SL)).lastusedtag_6);
                                                ;
                        ...
                        if(_VALUE(_IS(qty.descr_1,COMMON_extbrecord.class))) {
                            // JavaLine 100 <== SourceLine 76
                            {
                                // JavaLine 102 <== SourceLine 79
                                eee=((SCODER1E)(_CUR._SL._SL)).firstextmodule_6;
                                ;
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("SCODER1E.sim","5 GenerateSequPPtags",1,41,11,43,42,44,45,50,48,51,51,52,61,55,64,56,67,58,70,59,73,63,75,66,77,68,79,69,82,70,87,71,98,75,100,76,102,79,105,80,108,81,112,82,114,83,117,84,129,88,134,90,143,92);
} // End of Procedure
