...
public final class SCANNER_W8 extends RTS_PROCEDURE {
    ...
    @Override
    public SCANNER_W8 setPar(Object param) {
        try {
            switch(_nParLeft--) {
    ...
    public SCANNER_W8(RTS_RTObject _SL) {
        super(_SL,9); // Expecting 9 parameters
    }
    // Normal Constructor
    public SCANNER_W8(RTS_RTObject _SL,RTS_TXT sp_t,int sp_i1,int sp_i2,int sp_i3,int sp_i4,int sp_i5,int sp_i6,int sp_i7,int sp_i8) {
        super(_SL);
    ...
    @Override
    public SCANNER_W8 _STM() {
        // JavaLine 65 <== SourceLine 99
        {
            // BEGIN INSPECTION 
            _inspect_99_4466=RTS_BASICIO.sysout();
            if(_inspect_99_4466!=null) { // INSPECT _inspect_99_4466
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("SCANNER.sim","5 W8",1,98,19,100,65,99,70,100,81,101,88,102,101,102);
} // End of Procedure
