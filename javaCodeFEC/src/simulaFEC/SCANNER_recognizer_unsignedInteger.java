...
public boolean isDetachUsed() { return(true); }
    ...
    // Normal Constructor
    public SCANNER_recognizer_unsignedInteger(RTS_RTObject staticLink) {
        super(staticLink);
    ...
    // Class Statements
    @Override
    public SCANNER_recognizer_unsignedInteger _STM() {
        SCANNER_recognizer_unsignedInteger _THIS=(SCANNER_recognizer_unsignedInteger)_CUR;
        _LOOP:while(_JTX>=0) {
            try {
                ...
                while(true) {
                    {
                        ...
                        startpos=((SCANNER_recognizer)(_CUR._SL)).hashpos_1;
                        ;
                        radix=':';
                        ;
                        ...
                        while(true) {
                            {
                                ...
                                if(((SCANNER_recognizer)(_CUR._SL)).atom_1<((char)0) || ((SCANNER_recognizer)(_CUR._SL)).atom_1>((char)255)) throw new RTS_SimulaRuntimeError("Switch key outside key interval");
                                switch(((SCANNER_recognizer)(_CUR._SL)).atom_1) { // BEGIN SWITCH STATEMENT
                                    case 1: 
                                    case 2: 
                                    case 3: 
                                    case 4: 
                                    ...
                                    // JavaLine 244 <== SourceLine 964
                                    {
                                        ...
                                        i=(((SCANNER_recognizer)(_CUR._SL)).hashpos_1-(startpos));
                                        ;
                                        ...
                                        if(_VALUE((((i==(1))||((i==(2))))&&((radix==(':')))))) {
                                            // JavaLine 251 <== SourceLine 967
                                            {
                                                ...
                                                i=RTS_TXT.getint(RTS_TXT.sub(((SCANNER_recognizer)(_CUR._SL)).hashbuf_1,(startpos+(1)),i));
                                                ;
                                    ...
                                    if(_VALUE((!(((SCANNER_recognizer)(_CUR._SL)).skipzeroes_1)))) {
                                        {
                                            // JavaLine 280 <== SourceLine 977
                                            RTS_ENVIRONMENT.storeChar(((SCANNER_recognizer)(_CUR._SL)).atom_1,((SCANNER_recognizer)(_CUR._SL)).hashbuf_1,((SCANNER_recognizer)(_CUR._SL)).hashpos_1);
                                            ;
                                            // JavaLine 283 <== SourceLine 978
                                            ((SCANNER_recognizer)(_CUR._SL)).hashpos_1=(((SCANNER_recognizer)(_CUR._SL)).hashpos_1+(1));
                                        }
                                    }
                                    break;
                                    case 49: 
                                    ...
                                    // JavaLine 297 <== SourceLine 980
                                    {
                                        ...
                                        if(_VALUE((((SCANNER_recognizer)(_CUR._SL)).atom_1>=(radix)))) {
                                            {
                                                // JavaLine 302 <== SourceLine 982
                                                new SCANNER_P1error((_CUR._SL._SL),183);
                                                ;
                                                ((SCANNER_recognizer)(_CUR._SL)).atom_1='0';
                                            }
                                        }
                                        ;
                                        // JavaLine 309 <== SourceLine 983
                                        {
                                            _SIM_LABEL(1); // DeclaredIn: unsignedInteger -> unsignedInteger[SCANNER_recognizer_unsignedInteger] DeclarationKind=Class
                                            ((SCANNER_recognizer)(_CUR._SL)).skipzeroes_1=false;
                                        }
                                        ;
                                    ...
                                    // JavaLine 335 <== SourceLine 987
                                    {
                                        ...
                                        if(_VALUE((((SCANNER_recognizer)(_CUR._SL)).atom_1>=('a')))) {
                                            ((SCANNER_recognizer)(_CUR._SL)).atom_1=RTS_ENVIRONMENT._char((RTS_ENVIRONMENT.rank(((SCANNER_recognizer)(_CUR._SL)).atom_1)-(32)));
                                        }
                                        ;
                                ...
                                ;
                                ((SCANNER_recognizer)(_CUR._SL)).linepos_1=(((SCANNER_recognizer)(_CUR._SL)).linepos_1+(1));
                                ;
                                // JavaLine 362 <== SourceLine 998
                                if(_VALUE((((SCANNER_recognizer)(_CUR._SL)).linepos_1>(((SCANNER_recognizer)(_CUR._SL)).linelength_1)))) {
                                    new ERRMSG_internerr((_CUR._SL._SL),((char)2),998);
                                }
                            }
                        ...
                        {
                            _SIM_LABEL(2); // DeclaredIn: unsignedInteger -> unsignedInteger[SCANNER_recognizer_unsignedInteger] DeclarationKind=Class
                            ((SCANNER_recognizer)(_CUR._SL)).skipzeroes_1=false;
                        }
                        ;
                        // JavaLine 376 <== SourceLine 1003
                        if(_VALUE((startpos==(((SCANNER_recognizer)(_CUR._SL)).hashpos_1)))) {
                            {
                                // JavaLine 379 <== SourceLine 1004
                                RTS_ENVIRONMENT.storeChar('0',((SCANNER_recognizer)(_CUR._SL)).hashbuf_1,((SCANNER_recognizer)(_CUR._SL)).hashpos_1);
                                ;
                                ((SCANNER_recognizer)(_CUR._SL)).hashpos_1=(((SCANNER_recognizer)(_CUR._SL)).hashpos_1+(1));
                            }
                        } else {
