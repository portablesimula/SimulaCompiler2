...
public final class BUILDER2_prechecker_allocate_LAYOUT extends RTS_PROCEDURE {
    ...
    final RTS_LABEL _LABEL_BUILDER2_prechecker_allocate_LAYOUT_Block1686_Block1688_Block1689_Block1712_SIMOBTAG_0=new RTS_LABEL(this,0,1,"SIMOBTAG"); // Local Label #1=SIMOBTAG At PrefixLevel 0
    // Declare locals as attributes
    // JavaLine 14 <== SourceLine 1683
    public COMMON_quantity q=null;
    public COMMON_extquantity exq=null;
    // Parameter Transmission in case of Formal/Virtual Procedure Call
    @Override
    public BUILDER2_prechecker_allocate_LAYOUT setPar(Object param) {
        try {
            switch(_nParLeft--) {
    ...
    public BUILDER2_prechecker_allocate_LAYOUT(RTS_RTObject _SL) {
        super(_SL,1); // Expecting 1 parameters
    }
    // Normal Constructor
    public BUILDER2_prechecker_allocate_LAYOUT(RTS_RTObject _SL,COMMON_brecord sp_brc) {
        super(_SL);
    ...
    @Override
    public BUILDER2_prechecker_allocate_LAYOUT _STM() {
        BUILDER2_prechecker_allocate_LAYOUT _THIS=(BUILDER2_prechecker_allocate_LAYOUT)_CUR;
        _LOOP:while(_JTX>=0) {
            try {
                        ...
                        if(_VALUE((p_brc.kind!=(((char)13))))) {
                            {
                                ...
                                if(_VALUE(_IS(p_brc.declquant,COMMON_quantity.class))) {
                                    {
                                        // JavaLine 58 <== SourceLine 1689
                                        p_brc.declquant.ftag_1=new BUILDER1_newFirstTag((_CUR._SL._SL._SL),p_brc.declquant)._RESULT;
                                        ;
                                        ...
                                        if(_VALUE(((p_brc.kind==(((char)1)))&&((p_brc.declquant.plev_1==(2)))))) {
                                            ...
                                            if(_VALUE((((p_brc.kind==(((char)5)))||((p_brc.kind==(((char)9)))))||((p_brc.kind==(((char)7))))))) {
                                                ...
                                                new BUILDER2_prechecker_allocate_LAYOUT_Block1686_Block1688_Block1689_Block1700((_CUR))._STM();
                                            } else {
                                                // JavaLine 70 <== SourceLine 1711
                                                {
                                                    ...
                                                    if(_VALUE(((p_brc.kind==(((char)8)))||((p_brc.kind==(((char)1))))))) {
                                                        ...
                                                        new BUILDER1_newQTags((_CUR._SL._SL._SL),p_brc.declquant,2);
                                                    }
                                                    ;
                                                    // JavaLine 78 <== SourceLine 1715
                                                    {
                                                        _SIM_LABEL(1); // DeclaredIn: LAYOUT -> LAYOUT[externalIdent=BUILDER2_prechecker_allocate_LAYOUT] Kind=5, QUAL=ProcedureDeclaration, HashCode=127313865
                                                        if(_VALUE(((BUILDER2)(_CUR._SL._SL._SL)).simob_descr)) {
                                                            {
                                                                ...
                                                                if(_VALUE(((p_brc.kind==(((char)5)))||((p_brc.kind==(((char)1))))))) {
                                                                    // JavaLine 85 <== SourceLine 1717
                                                                    {
                                                                        ...
                                                                        new BUILDER1_newTTag((_CUR._SL._SL._SL),new RTS_TXT("bcnt"));
                                                                        ;
                                        ...
                                        new BUILDER1_newQTags((_CUR._SL._SL._SL),p_brc.declquant,p_brc.connests);
                                        ;
                                    }
                                } else {
                                    // JavaLine 107 <== SourceLine 1730
                                    if(_VALUE((((COMMON_extquantity)(p_brc.declquant)).p2_module==(null)))) {
                                        {
                                            // JavaLine 110 <== SourceLine 1732
                                            p_brc.declquant.ftag_1=(((BUILDER2)(_CUR._SL._SL._SL)).lastusedtag_6+(1));
                                            ;
                                            // JavaLine 113 <== SourceLine 1733
                                            new BUILDER1_newTags((_CUR._SL._SL._SL),(((p_brc.declquant.type_1!=(((char)14))))?(4):(3)));
                                            ;
                                        }
                                    }
                                }
                ...
                while((q!=(null))) {
                    {
                        ...
                        if(_VALUE(_IS(q,COMMON_extquantity.class))) {
                            {
                                // JavaLine 133 <== SourceLine 1743
                                if(_VALUE((((COMMON_extquantity)(q)).clf_2<=(((char)2))))) {
                                    {
                                        // JavaLine 136 <== SourceLine 1744
                                        if(_VALUE(_IS(q.descr_1,COMMON_extbrecord.class))) {
                                            {
                                                // JavaLine 139 <== SourceLine 1746
                                                ((COMMON_extbrecord)(q.descr_1)).ftag_1=(((BUILDER2)(_CUR._SL._SL._SL)).lastusedtag_6+(1));
                                                ;
                                                // JavaLine 142 <== SourceLine 1747
                                                new BUILDER1_newTags((_CUR._SL._SL._SL),((COMMON_extbrecord)(q.descr_1)).exttagnum_1);
                                                ;
                                            }
                                        }
                                        ;
                                        // JavaLine 148 <== SourceLine 1749
                                        if(_VALUE((((COMMON_extquantity)(q)).p2_module!=(null)))) {
                                            // JavaLine 150 <== SourceLine 1752
                                            q.ftag_1=(q.ftag_1+(((COMMON_extquantity)(q)).p2_module.ftag_1));
                                        } else {
                                            // JavaLine 153 <== SourceLine 1754
                                            if(_VALUE((((COMMON_extquantity)(q)).clf_2==(((char)2))))) {
                                                // JavaLine 155 <== SourceLine 1756
                                                q.ftag_1=new BUILDER1_newTTag((_CUR._SL._SL._SL),new RTS_TXT("Clf002"))._RESULT;
                                            }
                                        }
                                        ;
                                        ...
                                        if(_VALUE((q.special_1==(((char)0))))) {
                                            {
                                                ...
                                                if(_VALUE((q.descr_1!=(null)))) {
                                                    new BUILDER2_prechecker_allocate_LAYOUT((_CUR._SL),q.descr_1);
                                                }
                                            }
                                        }
                                        ;
                            ...
                            if(_VALUE((((((q.kind_1==(((char)1)))&&((q.categ_1==(((char)3)))))||((q.kind_1==(((char)6)))))||((q.kind_1==(((char)5)))))||((q.kind_1==(((char)7))))))) {
                                ...
                                if(_VALUE(((q.special_1>(((char)1)))&&((q.type_1!=(((char)8))))))) {
                                    ...
                                    // JavaLine 183 <== SourceLine 1768
                                    {
                                        ...
                                        q.ftag_1=new BUILDER1_newFirstTag((_CUR._SL._SL._SL),q)._RESULT;
                                        ;
                                        // JavaLine 188 <== SourceLine 1772
                                        if(_VALUE((q.categ_1==(((char)2))))) {
                                            new BUILDER1_newTTag((_CUR._SL._SL._SL),new RTS_TXT("C\u005fname"));
                                        }
                                        ;
                                    }
                                }
