...
public class CHECKER1_semchecker1_simpleIdent extends CHECKER1_semchecker1_identifier {
...
public boolean isDetachUsed() { return(true); }
    ...
    public RTS_PRCQNT sameAs_0() { return(new RTS_PRCQNT(this,CHECKER1_semchecker1_simpleIdent_sameAs.class)); }
    // Normal Constructor
    public CHECKER1_semchecker1_simpleIdent(RTS_RTObject staticLink,CHECKER1_semchecker1_exp sp_pred,char sp_ch) {
    ...
    // Class Statements
    @Override
    public CHECKER1_semchecker1_simpleIdent _STM() {
        ...
        while(true) {
            {
                ...
                if(_VALUE((meaning==(null)))) {
                    {
                        ...
                        new ERRMSG_error1id((_CUR._SL._SL),337,((CHECKER1_semchecker1)(_CUR._SL)).opdSymb_2);
                        ;
                        meaning.dim_1=2;
                        ;
                    ...
                    // JavaLine 61 <== SourceLine 1504
                    {
                        ...
                        switch(meaning.categ_1) { // BEGIN SWITCH STATEMENT
                                ...
                                if(_VALUE(((CHECKER1_semchecker1)(_CUR._SL)).inarraybound_2)) {
                                    {
                                        ...
                                        if(_VALUE((meaning.encl_1.rtblev==(((CHECKER1)(_CUR._SL._SL)).cblev_6)))) {
                                            // JavaLine 89 <== SourceLine 1519
                                            new ERRMSG_errQT((_CUR._SL._SL),meaning,316);
                                        }
                                    }
                                }
                            }
                            ...
                            if(_VALUE(((CHECKER1_semchecker1)(_CUR._SL)).inarraybound_2)) {
                                new ERRMSG_errQT((_CUR._SL._SL),meaning,312);
                            }
                            break;
                ...
                switch(kind) { // BEGIN SWITCH STATEMENT
                    ...
                    if(_VALUE((((CHECKER1_semchecker1)(_CUR._SL)).opttop_2!=(0)))) {
                        {
                            // JavaLine 125 <== SourceLine 1543
                            new CHECKER1_semchecker1_identifier_identError((_CUR),334);
                            ;
                            type=((char)7);
                            ;
                            qual=meaning;
                ...
                ((CHECKER1_semchecker1)(_CUR._SL)).simpleList_2=null;
                ;
                cl=((char)0);
                ;
                p_pred=((CHECKER1_semchecker1)(_CUR._SL)).exptop_2;
                ;
            }
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("CHECKER1.sim","8 simpleIdent",1,1482,21,169,23,1480,25,1491,28,1492,31,1494,34,1495,37,1497,40,1498,43,1499,49,1501,54,1502,61,1504,63,1505,68,1506,71,1510,74,1511,79,1513,81,1516,84,1517,87,1518,89,1519,97,1521,101,1523,111,1538,116,1540,122,1542,125,1543,132,1544,140,1549,143,1551,154,1554,161,1554);
} // End of Class
