...
public final class SCODER1_codegenerator1_conlevel extends RTS_PROCEDURE {
...
public Object _RESULT() { return(_RESULT); }
    ...
    public COMMON_brecord _inspect_814_4630=null;
    // JavaLine 15 <== SourceLine 805
    public int _RESULT=0;
    // Parameter Transmission in case of Formal/Virtual Procedure Call
    @Override
    public SCODER1_codegenerator1_conlevel setPar(Object param) {
        try {
            switch(_nParLeft--) {
    ...
    public SCODER1_codegenerator1_conlevel(RTS_RTObject _SL) {
        super(_SL,1); // Expecting 1 parameters
    }
    // Normal Constructor
    public SCODER1_codegenerator1_conlevel(RTS_RTObject _SL,COMMON_quantity sp_q) {
        super(_SL);
    ...
    @Override
    public SCODER1_codegenerator1_conlevel _STM() {
        ...
        // JavaLine 53 <== SourceLine 814
        {
            ...
            if(_inspect_814_4630!=null) { // INSPECT _inspect_814_4630
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("SCODER1.sim","5 conlevel",1,805,13,814,15,805,45,811,48,812,53,814,58,815,60,814,62,815,73,816);
} // End of Procedure
