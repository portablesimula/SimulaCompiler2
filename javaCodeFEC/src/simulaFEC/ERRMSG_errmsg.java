...
public Object _RESULT() { return(_RESULT); }
    ...
    @Override
    public ERRMSG_errmsg setPar(Object param) {
        try {
            switch(_nParLeft--) {
    ...
    public ERRMSG_errmsg(RTS_RTObject _SL) {
        super(_SL,1); // Expecting 1 parameters
    }
    // Normal Constructor
    public ERRMSG_errmsg(RTS_RTObject _SL,int sp_i) {
        super(_SL);
    ...
    @Override
    public ERRMSG_errmsg _STM() {
        ERRMSG_errmsg _THIS=(ERRMSG_errmsg)_CUR;
        _LOOP:while(_JTX>=0) {
            try {
                ...
                if(_VALUE((p_i==(0)))) {
                    ...
                    if(_VALUE(((ERRMSG)(_CUR._SL)).ERRnotopen_1)) {
                        {
                        ...
                        if(_VALUE(((p_i>(0))&&((p_i<=(450)))))) {
                            {
                                ...
                                if(_VALUE((((ERRMSG)(_CUR._SL)).ERRORFILE_1==(null)))) {
                                    {
                                        ...
                                        ((ERRMSG)(_CUR._SL)).ERRORFILE_1=new RTS_Directfile(_CTX,t)._STM();
                                        ;
                                        // JavaLine 86 <== SourceLine 133
                                        ((ERRMSG)(_CUR._SL)).ERRORFILE_1.setaccess(new RTS_TXT("READONLY"));
                                        ;
                                    }
                                }
                                ;
                                ...
                                if(_VALUE((!(((ERRMSG)(_CUR._SL)).ERRnotopen_1)))) {
                                    {
                                        ...
                                        if(_VALUE((!(((ERRMSG)(_CUR._SL)).ERRORFILE_1.open(t))))) {
                                            {
                                                // JavaLine 101 <== SourceLine 138
                                                new ERRMSG_printDiag((_CUR._SL),new RTS_TXT("*** CAN'T OPEN DIAGNOSTICS FILE ***"));
                                                ;
                                        ...
                                        ((ERRMSG)(_CUR._SL)).ERRORFILE_1.locate(p_i);
                                        ;
                                        ((ERRMSG)(_CUR._SL)).ERRORFILE_1.inimage();
                                        ;
                                        // JavaLine 117 <== SourceLine 147
                                        if(_VALUE(((ERRMSG)(_CUR._SL)).ERRORFILE_1.endfile())) {
                                            {
                                        ...
                                        _RESULT=RTS_ENVIRONMENT.copy(copy(RTS_TXT.strip(((ERRMSG)(_CUR._SL)).ERRORFILE_1.image)));
                                        ;
                                        // JavaLine 132 <== SourceLine 152
                                        ((ERRMSG)(_CUR._SL)).ERRORFILE_1.close();
                                        ;
                                    }
                                }
                                ;
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("ERRMSG.sim","5 errmsg",1,119,13,123,16,120,18,119,52,121,56,122,59,123,69,125,72,126,75,127,78,128,83,132,86,133,92,135,95,136,98,137,101,138,104,139,112,146,117,147,120,148,123,149,129,151,132,152,140,155,144,156,160,157);
} // End of Procedure
