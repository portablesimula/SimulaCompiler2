...
public class CHECKER1_semchecker1_newIdent extends CHECKER1_semchecker1_identifier {
    ...
    // Normal Constructor
    public CHECKER1_semchecker1_newIdent(RTS_RTObject staticLink,CHECKER1_semchecker1_exp sp_pred,char sp_ch) {
    ...
    // Class Statements
    @Override
    public CHECKER1_semchecker1_newIdent _STM() {
        ...
        qual=meaning=new CHECKER1_semchecker1_qualification((_CUR._SL))._RESULT;
        ;
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("CHECKER1.sim","8 newIdent",1,1697,19,169,21,1480,23,1699,26,1700,29,1701,34,1702,37,1703,45,1704,52,1704);
} // End of Class
