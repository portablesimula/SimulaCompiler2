...
public class BUILDER1_visiblegenerator_module extends RTS_CLASS {
    ...
    // Normal Constructor
    public BUILDER1_visiblegenerator_module(RTS_RTObject staticLink,RTS_TXT sp_rtsmoduleid,RTS_TXT sp_checkcode,int sp_numoftags,int sp_basetag) {
        super(staticLink);
    ...
    // Class Statements
    @Override
    public BUILDER1_visiblegenerator_module _STM() {
    ...
    public static RTS_PROGINFO _INFO=new RTS_PROGINFO("BUILDER1.sim","8 module",1,216,28,219,33,219);
} // End of Class
