...
//	private final static int EXPLICIT_REVISION = -1; // Normal update
	private final static int EXPLICIT_REVISION = 26;
...
//	// ***************************************************************
//	private static void dummyExecuteSimulaCompiler2() throws IOException	{
//		printHeading("Dummy Execute SimulaCompiler2: "+RELEASE_HOME+"\\simula.jar");
...
//	// ***************************************************************
//	private static void executeSimulaCompiler2Editor() throws IOException	{
//		printHeading("Execute SimulaCompiler2Editor: "+RELEASE_HOME+"\\simula.jar");
//		execute("java -jar "+RELEASE_HOME+"\\simula.jar");
//	}
